...
| Companion | [test procedures](WP-053_kueue_quota.tests.md) |
...
Each criterion names the test case in [`WP-053_kueue_quota.tests.md`](WP-053_kueue_quota.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
