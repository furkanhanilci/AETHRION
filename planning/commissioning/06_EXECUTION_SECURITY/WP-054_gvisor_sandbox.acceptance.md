...
| Companion | [test procedures](WP-054_gvisor_sandbox.tests.md) |
...
Each criterion names the test case in [`WP-054_gvisor_sandbox.tests.md`](WP-054_gvisor_sandbox.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
