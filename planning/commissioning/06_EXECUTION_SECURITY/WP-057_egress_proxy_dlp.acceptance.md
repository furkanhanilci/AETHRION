...
| Companion | [test procedures](WP-057_egress_proxy_dlp.tests.md) |
...
Each criterion names the test case in [`WP-057_egress_proxy_dlp.tests.md`](WP-057_egress_proxy_dlp.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
