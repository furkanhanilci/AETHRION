...
| Companion | [acceptance criteria](WP-060_security_attack_suite.acceptance.md) |
...
| C23 | Hidden Evaluation Data Access Attempt | [ACC-55](../12_ACCEPTANCE_SCENARIOS/ACC-55_hidden_evaluation_data_access.md) — Critical | *(name the test case)* |
...
| C25 | Prompt Injection Meets a Capability Gate | [ACC-117](../12_ACCEPTANCE_SCENARIOS/ACC-117_prompt_injection_capability_gate.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-060_security_attack_suite.acceptance.md) reaches the decision — issuance is not acceptance.
