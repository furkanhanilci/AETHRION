...
| Companion | [test procedures](WP-058_content_quarantine_firewall.tests.md) |
...
Each criterion names the test case in [`WP-058_content_quarantine_firewall.tests.md`](WP-058_content_quarantine_firewall.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
