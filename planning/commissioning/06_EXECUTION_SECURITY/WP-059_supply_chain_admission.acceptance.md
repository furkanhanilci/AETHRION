...
| Companion | [test procedures](WP-059_supply_chain_admission.tests.md) |
...
Each criterion names the test case in [`WP-059_supply_chain_admission.tests.md`](WP-059_supply_chain_admission.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
