...
| Companion | [test procedures](WP-083_experiment_batch.tests.md) |
...
Each criterion names the test case in [`WP-083_experiment_batch.tests.md`](WP-083_experiment_batch.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
