...
| Work package | [`WP-083` — ExperimentBatch and Staged Execution](WP-083_experiment_batch.md) |
| Companion | [acceptance criteria](WP-083_experiment_batch.acceptance.md) |
...
| C16 | Kueue Preemption | [ACC-33](../12_ACCEPTANCE_SCENARIOS/ACC-33_kueue_preemption.md) — High | *(name the test case)* |
| C17 | Negative Research Result | [ACC-39](../12_ACCEPTANCE_SCENARIOS/ACC-39_negative_result.md) — Medium | *(name the test case)* |
| C18 | Producer Attempts Evaluator Mutation | [ACC-54](../12_ACCEPTANCE_SCENARIOS/ACC-54_evaluator_mutation_attempt.md) — Critical | *(name the test case)* |
| C19 | Failed Smoke Candidate Promotion Attempt | [ACC-60](../12_ACCEPTANCE_SCENARIOS/ACC-60_failed_smoke_promotion.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-083_experiment_batch.acceptance.md) reaches the decision — issuance is not acceptance.
