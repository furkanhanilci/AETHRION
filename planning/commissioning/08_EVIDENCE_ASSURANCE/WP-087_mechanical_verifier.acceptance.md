...
| Companion | [test procedures](WP-087_mechanical_verifier.tests.md) |
...
Each criterion names the test case in [`WP-087_mechanical_verifier.tests.md`](WP-087_mechanical_verifier.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
