...
| Companion | [test procedures](WP-076_evidence_anchor_resolver.tests.md) |
...
Each criterion names the test case in [`WP-076_evidence_anchor_resolver.tests.md`](WP-076_evidence_anchor_resolver.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
