...
| Companion | [test procedures](WP-086_frozen_review_package.tests.md) |
...
Each criterion names the test case in [`WP-086_frozen_review_package.tests.md`](WP-086_frozen_review_package.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
