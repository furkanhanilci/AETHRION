...
| Companion | [acceptance criteria](WP-084_clean_room_environment.acceptance.md) |
...
[acceptance criteria](WP-084_clean_room_environment.acceptance.md) reaches the decision — issuance is not acceptance.
