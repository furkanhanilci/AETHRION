...
| Companion | [acceptance criteria](WP-080_citation_entailment_audit.acceptance.md) |
...
| C13 | Claimless Publication Assertion | [ACC-52](../12_ACCEPTANCE_SCENARIOS/ACC-52_claimless_publication_assertion.md) — Critical | *(name the test case)* |
| C14 | Unsupported Publication Sentence | [ACC-76](../12_ACCEPTANCE_SCENARIOS/ACC-76_unsupported_publication_sentence.md) — Critical | *(name the test case)* |
| C15 | A Claim Without a Complete Evidence Chain | [ACC-105](../12_ACCEPTANCE_SCENARIOS/ACC-105_claim_without_evidence_chain.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-080_citation_entailment_audit.acceptance.md) reaches the decision — issuance is not acceptance.
