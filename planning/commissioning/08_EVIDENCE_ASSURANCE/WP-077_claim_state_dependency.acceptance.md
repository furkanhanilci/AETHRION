...
| Companion | [test procedures](WP-077_claim_state_dependency.tests.md) |
...
Each criterion names the test case in [`WP-077_claim_state_dependency.tests.md`](WP-077_claim_state_dependency.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
