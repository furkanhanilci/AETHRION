...
| Companion | [test procedures](WP-081_protocol_baseline_registry.tests.md) |
...
Each criterion names the test case in [`WP-081_protocol_baseline_registry.tests.md`](WP-081_protocol_baseline_registry.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
