...
| Work package | [`WP-090` — PublicationPackage, RO-Crate and Provenance Export](WP-090_publication_package.md) |
| Companion | [acceptance criteria](WP-090_publication_package.acceptance.md) |
...
| C14 | Complete Project Audit Export | [ACC-40](../12_ACCEPTANCE_SCENARIOS/ACC-40_audit_export.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-090_publication_package.acceptance.md) reaches the decision — issuance is not acceptance.
