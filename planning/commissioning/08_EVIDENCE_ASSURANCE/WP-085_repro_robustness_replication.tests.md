...
| Companion | [acceptance criteria](WP-085_repro_robustness_replication.acceptance.md) |
...
| C16 | Clean-Room Reproduction Pass | [ACC-19](../12_ACCEPTANCE_SCENARIOS/ACC-19_clean_room_pass.md) — High | *(name the test case)* |
| C17 | Clean-Room Reproduction Failure | [ACC-20](../12_ACCEPTANCE_SCENARIOS/ACC-20_clean_room_fail.md) — Critical | *(name the test case)* |
| C18 | Reproduction in the Producer Environment | [ACC-65](../12_ACCEPTANCE_SCENARIOS/ACC-65_reproduction_in_producer_environment.md) — Critical | *(name the test case)* |
| C19 | Standalone Reproduction Package | [ACC-66](../12_ACCEPTANCE_SCENARIOS/ACC-66_standalone_reproduction_package.md) — Critical | *(name the test case)* |
| C20 | Claim–Code–Result Consistency Failure | [ACC-67](../12_ACCEPTANCE_SCENARIOS/ACC-67_claim_code_result_consistency.md) — Critical | *(name the test case)* |
| C21 | Reproduction Environment Lineage | [ACC-114](../12_ACCEPTANCE_SCENARIOS/ACC-114_reproduction_in_producer_environment_hardened.md) — Critical | *(name the test case)* |
| C22 | Distributional Reproduction for a Hosted Model | [ACC-116](../12_ACCEPTANCE_SCENARIOS/ACC-116_distributional_hosted_model_reproduction.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-085_repro_robustness_replication.acceptance.md) reaches the decision — issuance is not acceptance.
