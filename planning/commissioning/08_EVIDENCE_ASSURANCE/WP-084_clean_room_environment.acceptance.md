...
| Work package | [`WP-084` — Clean-Room Reproduction Environment](WP-084_clean_room_environment.md) |
| Companion | [test procedures](WP-084_clean_room_environment.tests.md) |
...
Each criterion names the test case in [`WP-084_clean_room_environment.tests.md`](WP-084_clean_room_environment.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
