...
| Companion | [test procedures](WP-090_publication_package.tests.md) |
...
Each criterion names the test case in [`WP-090_publication_package.tests.md`](WP-090_publication_package.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
