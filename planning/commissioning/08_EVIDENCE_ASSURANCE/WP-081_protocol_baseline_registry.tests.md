...
| C13 | Confirmatory Result Without a Frozen Analysis Plan | [ACC-56](../12_ACCEPTANCE_SCENARIOS/ACC-56_confirmatory_without_frozen_plan.md) — Critical | *(name the test case)* |
| C14 | Minor Specification Drift Is Recorded | [ACC-103](../12_ACCEPTANCE_SCENARIOS/ACC-103_scientific_minor_spec_drift.md) — High | *(name the test case)* |
| C15 | Major Specification Drift Blocks Confirmatory Status | [ACC-104](../12_ACCEPTANCE_SCENARIOS/ACC-104_scientific_major_spec_drift.md) — Critical | *(name the test case)* |
