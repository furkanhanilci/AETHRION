...
| Work package | [`WP-075` — Canonical Claim/Evidence Ledger Service](WP-075_claim_evidence_ledger.md) |
| Companion | [test procedures](WP-075_claim_evidence_ledger.tests.md) |
...
Each criterion names the test case in [`WP-075_claim_evidence_ledger.tests.md`](WP-075_claim_evidence_ledger.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
