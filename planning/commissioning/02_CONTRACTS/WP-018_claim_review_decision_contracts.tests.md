...
| Companion | [acceptance criteria](WP-018_claim_review_decision_contracts.acceptance.md) |
...
| C16 | Claimless Publication Assertion | [ACC-52](../12_ACCEPTANCE_SCENARIOS/ACC-52_claimless_publication_assertion.md) — Critical | *(name the test case)* |
| C17 | Hypothesis In-Place Mutation Attempt | [ACC-57](../12_ACCEPTANCE_SCENARIOS/ACC-57_hypothesis_in_place_mutation.md) — High | *(name the test case)* |
| C18 | Semantic Verifier Recorded as Mechanical | [ACC-62](../12_ACCEPTANCE_SCENARIOS/ACC-62_verifier_class_misdeclaration.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-018_claim_review_decision_contracts.acceptance.md) reaches the decision — issuance is not acceptance.
