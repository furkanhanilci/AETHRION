...
| Companion | [test procedures](WP-012_canonical_field_authority.tests.md) |
...
Each criterion names the test case in [`WP-012_canonical_field_authority.tests.md`](WP-012_canonical_field_authority.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
