...
| Companion | [test procedures](WP-020_schema_registry_sdk.tests.md) |
...
Each criterion names the test case in [`WP-020_schema_registry_sdk.tests.md`](WP-020_schema_registry_sdk.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
