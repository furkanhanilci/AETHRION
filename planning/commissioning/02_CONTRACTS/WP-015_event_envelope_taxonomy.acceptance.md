...
| Companion | [test procedures](WP-015_event_envelope_taxonomy.tests.md) |
...
Each criterion names the test case in [`WP-015_event_envelope_taxonomy.tests.md`](WP-015_event_envelope_taxonomy.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
