...
| Companion | [acceptance criteria](WP-016_policy_control_exception_contracts.acceptance.md) |
...
[acceptance criteria](WP-016_policy_control_exception_contracts.acceptance.md) reaches the decision — issuance is not acceptance.
