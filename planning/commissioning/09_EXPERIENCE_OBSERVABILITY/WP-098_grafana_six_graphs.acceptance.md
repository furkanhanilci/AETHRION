...
| Work package | [`WP-098` — Grafana and the Six Operational Graphs](WP-098_grafana_six_graphs.md) |
| Companion | [test procedures](WP-098_grafana_six_graphs.tests.md) |
...
Each criterion names the test case in [`WP-098_grafana_six_graphs.tests.md`](WP-098_grafana_six_graphs.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
