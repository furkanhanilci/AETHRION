...
| Work package | [`WP-095` — Claim/Evidence Explorer and Provenance Graph](WP-095_claim_evidence_explorer.md) |
| Companion | [acceptance criteria](WP-095_claim_evidence_explorer.acceptance.md) |
...
| C14 | Derived Graph Corruption and Rebuild | [ACC-21](../12_ACCEPTANCE_SCENARIOS/ACC-21_graph_corruption.md) — High | *(name the test case)* |
...
| C16 | Superseded Publication | [ACC-31](../12_ACCEPTANCE_SCENARIOS/ACC-31_superseded_publication.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-095_claim_evidence_explorer.acceptance.md) reaches the decision — issuance is not acceptance.
