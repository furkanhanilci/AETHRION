...
| Companion | [test procedures](WP-096_otel_correlation.tests.md) |
...
Each criterion names the test case in [`WP-096_otel_correlation.tests.md`](WP-096_otel_correlation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
