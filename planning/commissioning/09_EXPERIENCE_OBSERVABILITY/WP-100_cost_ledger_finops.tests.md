...
| Work package | [`WP-100` — Cost Ledger, Budget Envelopes and FinOps](WP-100_cost_ledger_finops.md) |
| Companion | [acceptance criteria](WP-100_cost_ledger_finops.acceptance.md) |
...
| C13 | Provider Invoice Variance | [ACC-29](../12_ACCEPTANCE_SCENARIOS/ACC-29_invoice_variance.md) — Medium | *(name the test case)* |
...
[acceptance criteria](WP-100_cost_ledger_finops.acceptance.md) reaches the decision — issuance is not acceptance.
