...
| Work package | [`WP-094` — Literature Workbench and Reconciliation UI](WP-094_literature_workbench.md) |
| Companion | [acceptance criteria](WP-094_literature_workbench.acceptance.md) |
...
| C15 | Retraction Impact | [ACC-04](../12_ACCEPTANCE_SCENARIOS/ACC-04_retraction_impact.md) — Critical | *(name the test case)* |
| C16 | Zotero Full Resync | [ACC-28](../12_ACCEPTANCE_SCENARIOS/ACC-28_zotero_full_resync.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-094_literature_workbench.acceptance.md) reaches the decision — issuance is not acceptance.
