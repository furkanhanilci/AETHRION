...
| Companion | [test procedures](WP-095_claim_evidence_explorer.tests.md) |
...
Each criterion names the test case in [`WP-095_claim_evidence_explorer.tests.md`](WP-095_claim_evidence_explorer.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
