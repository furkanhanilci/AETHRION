...
| Companion | [test procedures](WP-094_literature_workbench.tests.md) |
...
Each criterion names the test case in [`WP-094_literature_workbench.tests.md`](WP-094_literature_workbench.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
