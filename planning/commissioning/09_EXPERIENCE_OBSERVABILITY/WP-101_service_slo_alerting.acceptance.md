...
| Work package | [`WP-101` — Service Catalogue, SLOs and Alert/Runbook Binding](WP-101_service_slo_alerting.md) |
| Companion | [test procedures](WP-101_service_slo_alerting.tests.md) |
...
Each criterion names the test case in [`WP-101_service_slo_alerting.tests.md`](WP-101_service_slo_alerting.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
