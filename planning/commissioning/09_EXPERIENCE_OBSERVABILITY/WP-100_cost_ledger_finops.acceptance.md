...
| Companion | [test procedures](WP-100_cost_ledger_finops.tests.md) |
...
Each criterion names the test case in [`WP-100_cost_ledger_finops.tests.md`](WP-100_cost_ledger_finops.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
