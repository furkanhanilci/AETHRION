...
| Companion | [acceptance criteria](WP-099_audit_worm_export.acceptance.md) |
...
| C12 | Complete Project Audit Export | [ACC-40](../12_ACCEPTANCE_SCENARIOS/ACC-40_audit_export.md) — Critical | *(name the test case)* |
| C13 | Human Intervention Without an Audit Record | [ACC-68](../12_ACCEPTANCE_SCENARIOS/ACC-68_human_intervention_audit.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-099_audit_worm_export.acceptance.md) reaches the decision — issuance is not acceptance.
