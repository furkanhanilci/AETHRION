...
| Companion | [test procedures](WP-092_project_gate_timeline.tests.md) |
...
Each criterion names the test case in [`WP-092_project_gate_timeline.tests.md`](WP-092_project_gate_timeline.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
