...
| Companion | [test procedures](WP-153_research_budget_and_token_ledger.tests.md) |
...
Each criterion names the test case in [`WP-153_research_budget_and_token_ledger.tests.md`](WP-153_research_budget_and_token_ledger.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
