...
| Companion | [test procedures](WP-152_failure_taxonomy_and_resilience.tests.md) |
...
Each criterion names the test case in [`WP-152_failure_taxonomy_and_resilience.tests.md`](WP-152_failure_taxonomy_and_resilience.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
