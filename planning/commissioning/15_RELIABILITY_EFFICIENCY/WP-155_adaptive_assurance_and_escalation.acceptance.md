...
| Companion | [test procedures](WP-155_adaptive_assurance_and_escalation.tests.md) |
...
Each criterion names the test case in [`WP-155_adaptive_assurance_and_escalation.tests.md`](WP-155_adaptive_assurance_and_escalation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
