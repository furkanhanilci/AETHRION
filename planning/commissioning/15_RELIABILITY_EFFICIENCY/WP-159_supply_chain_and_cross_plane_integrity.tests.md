...
| Companion | [acceptance criteria](WP-159_supply_chain_and_cross_plane_integrity.acceptance.md) |
...
| C14 | Destructive Projection Rebuild | [ACC-119](../12_ACCEPTANCE_SCENARIOS/ACC-119_derived_projection_destructive_rebuild.md) — Critical | *(name the test case)* |
| C15 | Missing Upstream Licence or Provenance | [ACC-120](../12_ACCEPTANCE_SCENARIOS/ACC-120_missing_upstream_license_provenance.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-159_supply_chain_and_cross_plane_integrity.acceptance.md) reaches the decision — issuance is not acceptance.
