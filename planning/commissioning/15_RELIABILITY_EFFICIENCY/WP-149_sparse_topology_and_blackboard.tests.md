...
| C16 | Independent-First Embargo | [ACC-082](../12_ACCEPTANCE_SCENARIOS/ACC-082_independent_first_embargo.md) — Critical | *(name the test case)* |
| C17 | Typed Inter-Agent Message | [ACC-083](../12_ACCEPTANCE_SCENARIOS/ACC-083_typed_inter_agent_message.md) — High | *(name the test case)* |
| C18 | Delta-Only Communication | [ACC-084](../12_ACCEPTANCE_SCENARIOS/ACC-084_delta_only_communication.md) — High | *(name the test case)* |
| C19 | A Blackboard Entry Is Not Evidence | [ACC-085](../12_ACCEPTANCE_SCENARIOS/ACC-085_blackboard_entry_is_not_evidence.md) — Critical | *(name the test case)* |
| C20 | Sparse Topology Preserves Quality | [ACC-086](../12_ACCEPTANCE_SCENARIOS/ACC-086_sparse_topology_quality_preservation.md) — High | *(name the test case)* |
