...
| Companion | [test procedures](WP-148_multi_agent_collaboration_plane.tests.md) |
...
Each criterion names the test case in [`WP-148_multi_agent_collaboration_plane.tests.md`](WP-148_multi_agent_collaboration_plane.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
