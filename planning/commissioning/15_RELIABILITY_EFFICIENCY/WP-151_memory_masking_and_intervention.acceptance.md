...
| Companion | [test procedures](WP-151_memory_masking_and_intervention.tests.md) |
...
Each criterion names the test case in [`WP-151_memory_masking_and_intervention.tests.md`](WP-151_memory_masking_and_intervention.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
