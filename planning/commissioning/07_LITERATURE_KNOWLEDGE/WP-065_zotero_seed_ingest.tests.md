...
| Companion | [acceptance criteria](WP-065_zotero_seed_ingest.acceptance.md) |
...
[acceptance criteria](WP-065_zotero_seed_ingest.acceptance.md) reaches the decision — issuance is not acceptance.
