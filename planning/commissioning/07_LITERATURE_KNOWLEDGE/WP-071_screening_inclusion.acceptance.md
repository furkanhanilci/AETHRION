...
| Companion | [test procedures](WP-071_screening_inclusion.tests.md) |
...
Each criterion names the test case in [`WP-071_screening_inclusion.tests.md`](WP-071_screening_inclusion.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
