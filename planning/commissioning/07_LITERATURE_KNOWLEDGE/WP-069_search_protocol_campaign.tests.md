...
| Work package | [`WP-069` — SearchProtocol and LiteratureCampaign Orchestration](WP-069_search_protocol_campaign.md) |
| Companion | [acceptance criteria](WP-069_search_protocol_campaign.acceptance.md) |
...
[acceptance criteria](WP-069_search_protocol_campaign.acceptance.md) reaches the decision — issuance is not acceptance.
