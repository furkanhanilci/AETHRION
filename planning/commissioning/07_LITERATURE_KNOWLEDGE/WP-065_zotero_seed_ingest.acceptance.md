...
| Work package | [`WP-065` — Personal Zotero Seed Ingest Pipeline](WP-065_zotero_seed_ingest.md) |
| Companion | [test procedures](WP-065_zotero_seed_ingest.tests.md) |
...
Each criterion names the test case in [`WP-065_zotero_seed_ingest.tests.md`](WP-065_zotero_seed_ingest.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
