...
| Companion | [test procedures](WP-067_zotero_sync_reconciliation.tests.md) |
...
Each criterion names the test case in [`WP-067_zotero_sync_reconciliation.tests.md`](WP-067_zotero_sync_reconciliation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
