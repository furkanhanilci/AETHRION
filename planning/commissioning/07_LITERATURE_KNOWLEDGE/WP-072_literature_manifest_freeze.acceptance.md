...
| Companion | [test procedures](WP-072_literature_manifest_freeze.tests.md) |
...
Each criterion names the test case in [`WP-072_literature_manifest_freeze.tests.md`](WP-072_literature_manifest_freeze.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
