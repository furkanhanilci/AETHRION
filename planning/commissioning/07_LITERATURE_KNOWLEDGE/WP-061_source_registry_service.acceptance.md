...
| Companion | [test procedures](WP-061_source_registry_service.tests.md) |
...
Each criterion names the test case in [`WP-061_source_registry_service.tests.md`](WP-061_source_registry_service.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
