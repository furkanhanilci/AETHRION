...
| Companion | [acceptance criteria](WP-068_zotero_annotation_ingest.acceptance.md) |
...
[acceptance criteria](WP-068_zotero_annotation_ingest.acceptance.md) reaches the decision — issuance is not acceptance.
