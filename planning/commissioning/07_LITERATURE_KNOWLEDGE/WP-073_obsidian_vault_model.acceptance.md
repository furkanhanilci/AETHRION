...
| Work package | [`WP-073` — Obsidian Vault, Human/Generated Zones and Templates](WP-073_obsidian_vault_model.md) |
| Companion | [test procedures](WP-073_obsidian_vault_model.tests.md) |
...
Each criterion names the test case in [`WP-073_obsidian_vault_model.tests.md`](WP-073_obsidian_vault_model.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
