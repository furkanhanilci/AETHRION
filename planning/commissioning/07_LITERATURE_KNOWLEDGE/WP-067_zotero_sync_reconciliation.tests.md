...
| Work package | [`WP-067` — Zotero Two-Way Sync and Reconciliation](WP-067_zotero_sync_reconciliation.md) |
| Companion | [acceptance criteria](WP-067_zotero_sync_reconciliation.acceptance.md) |
...
| C11 | Duplicate and Metadata Collision | [ACC-03](../12_ACCEPTANCE_SCENARIOS/ACC-03_duplicate_collision.md) — High | *(name the test case)* |
| C12 | Zotero Full Resync | [ACC-28](../12_ACCEPTANCE_SCENARIOS/ACC-28_zotero_full_resync.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-067_zotero_sync_reconciliation.acceptance.md) reaches the decision — issuance is not acceptance.
