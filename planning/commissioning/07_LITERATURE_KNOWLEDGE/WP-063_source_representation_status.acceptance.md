...
| Work package | [`WP-063` — Source Representation, Licence and Status Monitoring](WP-063_source_representation_status.md) |
| Companion | [test procedures](WP-063_source_representation_status.tests.md) |
...
Each criterion names the test case in [`WP-063_source_representation_status.tests.md`](WP-063_source_representation_status.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
