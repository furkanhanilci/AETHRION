...
| Work package | [`WP-074` — Obsidian Projection, Link Integrity and Knowledge Write-Back](WP-074_obsidian_projection_sync.md) |
| Companion | [acceptance criteria](WP-074_obsidian_projection_sync.acceptance.md) |
...
| C13 | Obsidian Human Edit Preservation | [ACC-22](../12_ACCEPTANCE_SCENARIOS/ACC-22_obsidian_human_edit.md) — High | *(name the test case)* |
| C14 | Superseded Publication | [ACC-31](../12_ACCEPTANCE_SCENARIOS/ACC-31_superseded_publication.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-074_obsidian_projection_sync.acceptance.md) reaches the decision — issuance is not acceptance.
