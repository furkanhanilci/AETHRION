...
| Companion | [test procedures](WP-074_obsidian_projection_sync.tests.md) |
...
Each criterion names the test case in [`WP-074_obsidian_projection_sync.tests.md`](WP-074_obsidian_projection_sync.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
