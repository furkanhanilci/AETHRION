...
| Companion | [test procedures](WP-069_search_protocol_campaign.tests.md) |
...
Each criterion names the test case in [`WP-069_search_protocol_campaign.tests.md`](WP-069_search_protocol_campaign.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
