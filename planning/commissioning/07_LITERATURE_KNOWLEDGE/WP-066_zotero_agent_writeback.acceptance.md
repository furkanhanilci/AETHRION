...
| Companion | [test procedures](WP-066_zotero_agent_writeback.tests.md) |
...
Each criterion names the test case in [`WP-066_zotero_agent_writeback.tests.md`](WP-066_zotero_agent_writeback.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
