...
| Companion | [test procedures](WP-133_outbound_notification_and_digest.tests.md) |
...
Each criterion names the test case in [`WP-133_outbound_notification_and_digest.tests.md`](WP-133_outbound_notification_and_digest.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
