...
| Companion | [test procedures](WP-132_channel_registry_data_class_ceiling.tests.md) |
...
Each criterion names the test case in [`WP-132_channel_registry_data_class_ceiling.tests.md`](WP-132_channel_registry_data_class_ceiling.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
