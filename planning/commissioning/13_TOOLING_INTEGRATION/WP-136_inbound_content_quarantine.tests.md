...
| Companion | [acceptance criteria](WP-136_inbound_content_quarantine.acceptance.md) |
...
| C08 | Prompt-Injection PDF | [ACC-05](../12_ACCEPTANCE_SCENARIOS/ACC-05_prompt_injection_pdf.md) — Critical | *(name the test case)* |
| C09 | Inbound Content Attempts to Act as an Instruction | [ACC-44](../12_ACCEPTANCE_SCENARIOS/ACC-44_inbound_message_is_not_an_instruction.md) — Critical | *(name the test case)* |
| C10 | Prompt Injection Meets a Capability Gate | [ACC-117](../12_ACCEPTANCE_SCENARIOS/ACC-117_prompt_injection_capability_gate.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-136_inbound_content_quarantine.acceptance.md) reaches the decision — issuance is not acceptance.
