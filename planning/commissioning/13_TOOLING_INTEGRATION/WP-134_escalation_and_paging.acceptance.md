...
| Companion | [test procedures](WP-134_escalation_and_paging.tests.md) |
...
Each criterion names the test case in [`WP-134_escalation_and_paging.tests.md`](WP-134_escalation_and_paging.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
