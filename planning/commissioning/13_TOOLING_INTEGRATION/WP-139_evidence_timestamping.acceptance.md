...
| Companion | [test procedures](WP-139_evidence_timestamping.tests.md) |
...
Each criterion names the test case in [`WP-139_evidence_timestamping.tests.md`](WP-139_evidence_timestamping.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
