...
| Work package | [`WP-139` — Evidence Timestamping and Independent Seal](WP-139_evidence_timestamping.md) |
| Companion | [acceptance criteria](WP-139_evidence_timestamping.acceptance.md) |
...
| C07 | Artifact Overwrite Attempt | [ACC-23](../12_ACCEPTANCE_SCENARIOS/ACC-23_artifact_overwrite.md) — Critical | *(name the test case)* |
| C08 | Complete Project Audit Export | [ACC-40](../12_ACCEPTANCE_SCENARIOS/ACC-40_audit_export.md) — Critical | *(name the test case)* |
| C09 | Irreversible External Record Submission | [ACC-45](../12_ACCEPTANCE_SCENARIOS/ACC-45_external_record_submission.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-139_evidence_timestamping.acceptance.md) reaches the decision — issuance is not acceptance.
