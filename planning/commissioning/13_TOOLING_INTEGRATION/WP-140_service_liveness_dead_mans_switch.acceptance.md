...
| Companion | [test procedures](WP-140_service_liveness_dead_mans_switch.tests.md) |
...
Each criterion names the test case in [`WP-140_service_liveness_dead_mans_switch.tests.md`](WP-140_service_liveness_dead_mans_switch.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
