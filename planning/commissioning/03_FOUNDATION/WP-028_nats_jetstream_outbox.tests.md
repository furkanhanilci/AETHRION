...
| Companion | [acceptance criteria](WP-028_nats_jetstream_outbox.acceptance.md) |
...
| C12 | Duplicate Event Delivery | [ACC-12](../12_ACCEPTANCE_SCENARIOS/ACC-12_duplicate_event.md) — Critical | *(name the test case)* |
| C13 | DLQ Repair and Corrected Replay | [ACC-34](../12_ACCEPTANCE_SCENARIOS/ACC-34_dlq_repair.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-028_nats_jetstream_outbox.acceptance.md) reaches the decision — issuance is not acceptance.
