...
| Companion | [test procedures](WP-021_environment_account_network_baseline.tests.md) |
...
Each criterion names the test case in [`WP-021_environment_account_network_baseline.tests.md`](WP-021_environment_account_network_baseline.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
