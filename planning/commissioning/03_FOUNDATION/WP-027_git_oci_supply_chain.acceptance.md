...
| Companion | [test procedures](WP-027_git_oci_supply_chain.tests.md) |
...
Each criterion names the test case in [`WP-027_git_oci_supply_chain.tests.md`](WP-027_git_oci_supply_chain.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
