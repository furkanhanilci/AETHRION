...
| Work package | [`WP-029` — MLflow Experiment and Evaluation Tracking Foundation](WP-029_mlflow_foundation.md) |
| Companion | [test procedures](WP-029_mlflow_foundation.tests.md) |
...
Each criterion names the test case in [`WP-029_mlflow_foundation.tests.md`](WP-029_mlflow_foundation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
