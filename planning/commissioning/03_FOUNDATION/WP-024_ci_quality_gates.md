...
| [Test procedures](WP-024_ci_quality_gates.tests.md) | How is it tested, in what environment, with what data, and what counts as a complete run? | The implementer and the tester |
| [Acceptance criteria](WP-024_ci_quality_gates.acceptance.md) | What must hold for this to be `ACCEPTED`, and what does it still not establish? | The independent verifier |
...
- **Directly unblocked:** 7 — `WP-027` · `WP-040` · `WP-087` · `WP-107` · `WP-109` · `WP-141` · `WP-159`
- **Transitively reachable:** **123 of 160 packages (77%)** cannot be accepted until this one is.
...
- `Flake policy`
- `SPDX/REUSE and OSV admission checks`
- An updated runbook or operations note, plus the service/contract ownership record
- A signed `EvidenceManifest`

## Test and verification plan

The outline below is the summary. The executable procedure — environment, data, coverage items, cases, execution log, incident and completion reports — is in [`WP-024_ci_quality_gates.tests.md`](WP-024_ci_quality_gates.tests.md).
...
The programme-level conditions are below. The package-specific, measurable criteria — each with a threshold and the test case that decides it — are in [`WP-024_ci_quality_gates.acceptance.md`](WP-024_ci_quality_gates.acceptance.md), together with what this package still cannot establish.
