...
| Companion | [acceptance criteria](WP-025_postgres_ha_foundation.acceptance.md) |
...
[acceptance criteria](WP-025_postgres_ha_foundation.acceptance.md) reaches the decision — issuance is not acceptance.
