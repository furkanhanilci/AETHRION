...
| Companion | [test procedures](WP-030_derived_read_models.tests.md) |
...
Each criterion names the test case in [`WP-030_derived_read_models.tests.md`](WP-030_derived_read_models.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
