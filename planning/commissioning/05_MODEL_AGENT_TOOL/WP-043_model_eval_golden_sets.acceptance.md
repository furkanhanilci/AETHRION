...
| Companion | [test procedures](WP-043_model_eval_golden_sets.tests.md) |
...
Each criterion names the test case in [`WP-043_model_eval_golden_sets.tests.md`](WP-043_model_eval_golden_sets.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
