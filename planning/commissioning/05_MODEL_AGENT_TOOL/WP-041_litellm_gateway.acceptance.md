...
| Companion | [test procedures](WP-041_litellm_gateway.tests.md) |
...
Each criterion names the test case in [`WP-041_litellm_gateway.tests.md`](WP-041_litellm_gateway.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
