...
| C12 | Prompt-Injection PDF | [ACC-05](../12_ACCEPTANCE_SCENARIOS/ACC-05_prompt_injection_pdf.md) — Critical | *(name the test case)* |
| C13 | Duplicate Event Delivery | [ACC-12](../12_ACCEPTANCE_SCENARIOS/ACC-12_duplicate_event.md) — Critical | *(name the test case)* |
| C14 | Tool Partial Failure | [ACC-35](../12_ACCEPTANCE_SCENARIOS/ACC-35_tool_partial_failure.md) — Critical | *(name the test case)* |
