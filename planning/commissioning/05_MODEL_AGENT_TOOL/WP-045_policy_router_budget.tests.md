...
| Work package | [`WP-045` — Policy Router and Minimum-Sufficient Model Package](WP-045_policy_router_budget.md) |
| Companion | [acceptance criteria](WP-045_policy_router_budget.acceptance.md) |
...
[acceptance criteria](WP-045_policy_router_budget.acceptance.md) reaches the decision — issuance is not acceptance.
