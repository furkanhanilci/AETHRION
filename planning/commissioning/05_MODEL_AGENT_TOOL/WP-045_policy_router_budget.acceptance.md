...
| Companion | [test procedures](WP-045_policy_router_budget.tests.md) |
...
Each criterion names the test case in [`WP-045_policy_router_budget.tests.md`](WP-045_policy_router_budget.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
