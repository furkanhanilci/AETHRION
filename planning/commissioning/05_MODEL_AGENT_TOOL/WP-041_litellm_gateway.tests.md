...
| Work package | [`WP-041` — LiteLLM Model Gateway Foundation](WP-041_litellm_gateway.md) |
| Companion | [acceptance criteria](WP-041_litellm_gateway.acceptance.md) |
...
| C14 | No Eligible Fallback | [ACC-11](../12_ACCEPTANCE_SCENARIOS/ACC-11_no_eligible_fallback.md) — Critical | *(name the test case)* |
| C15 | D3 Data to a Public Provider | [ACC-18](../12_ACCEPTANCE_SCENARIOS/ACC-18_d3_public_route.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-041_litellm_gateway.acceptance.md) reaches the decision — issuance is not acceptance.
