...
| Work package | [`WP-050` — Initial Tool Connector Package](WP-050_tool_connectors.md) |
| Companion | [test procedures](WP-050_tool_connectors.tests.md) |
...
Each criterion names the test case in [`WP-050_tool_connectors.tests.md`](WP-050_tool_connectors.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
