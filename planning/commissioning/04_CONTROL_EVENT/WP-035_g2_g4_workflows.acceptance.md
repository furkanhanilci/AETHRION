...
| Companion | [test procedures](WP-035_g2_g4_workflows.tests.md) |
...
Each criterion names the test case in [`WP-035_g2_g4_workflows.tests.md`](WP-035_g2_g4_workflows.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
