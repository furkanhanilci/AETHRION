...
| Companion | [test procedures](WP-037_g10_impactscan.tests.md) |
...
Each criterion names the test case in [`WP-037_g10_impactscan.tests.md`](WP-037_g10_impactscan.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
