...
| Companion | [test procedures](WP-032_project_lifecycle_skeleton.tests.md) |
...
Each criterion names the test case in [`WP-032_project_lifecycle_skeleton.tests.md`](WP-032_project_lifecycle_skeleton.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
