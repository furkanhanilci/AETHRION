...
| Companion | [acceptance criteria](WP-039_event_consumer_dlq_replay.acceptance.md) |
...
[acceptance criteria](WP-039_event_consumer_dlq_replay.acceptance.md) reaches the decision — issuance is not acceptance.
