...
| Companion | [test procedures](WP-031_temporal_platform.tests.md) |
...
Each criterion names the test case in [`WP-031_temporal_platform.tests.md`](WP-031_temporal_platform.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
