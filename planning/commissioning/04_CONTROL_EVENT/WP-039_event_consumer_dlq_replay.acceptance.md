...
| Work package | [`WP-039` — Event Consumer, DLQ and Safe Replay Framework](WP-039_event_consumer_dlq_replay.md) |
| Companion | [test procedures](WP-039_event_consumer_dlq_replay.tests.md) |
...
Each criterion names the test case in [`WP-039_event_consumer_dlq_replay.tests.md`](WP-039_event_consumer_dlq_replay.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
