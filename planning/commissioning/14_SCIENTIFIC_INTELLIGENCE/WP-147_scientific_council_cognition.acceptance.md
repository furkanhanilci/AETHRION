...
| Companion | [test procedures](WP-147_scientific_council_cognition.tests.md) |
...
Each criterion names the test case in [`WP-147_scientific_council_cognition.tests.md`](WP-147_scientific_council_cognition.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
