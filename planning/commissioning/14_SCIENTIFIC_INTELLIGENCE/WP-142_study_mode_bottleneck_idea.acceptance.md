...
| Companion | [test procedures](WP-142_study_mode_bottleneck_idea.tests.md) |
...
Each criterion names the test case in [`WP-142_study_mode_bottleneck_idea.tests.md`](WP-142_study_mode_bottleneck_idea.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
