...
| Companion | [test procedures](WP-144_discovery_search_graph.tests.md) |
...
Each criterion names the test case in [`WP-144_discovery_search_graph.tests.md`](WP-144_discovery_search_graph.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
