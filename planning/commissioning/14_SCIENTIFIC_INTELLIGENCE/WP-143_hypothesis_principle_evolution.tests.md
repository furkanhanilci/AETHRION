...
| C15 | Implementation Failure Must Not Refute a Hypothesis | [ACC-64](../12_ACCEPTANCE_SCENARIOS/ACC-64_implementation_failure_not_refutation.md) — Critical | *(name the test case)* |
