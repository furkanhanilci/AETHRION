...
| Companion | [test procedures](WP-145_search_selection_fusion_stagnation.tests.md) |
...
Each criterion names the test case in [`WP-145_search_selection_fusion_stagnation.tests.md`](WP-145_search_selection_fusion_stagnation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
