...
| Companion | [test procedures](WP-104_vertical_slice_run_claim.tests.md) |
...
Each criterion names the test case in [`WP-104_vertical_slice_run_claim.tests.md`](WP-104_vertical_slice_run_claim.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
