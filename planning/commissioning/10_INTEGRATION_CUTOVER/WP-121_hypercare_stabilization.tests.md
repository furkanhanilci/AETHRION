...
| Companion | [acceptance criteria](WP-121_hypercare_stabilization.acceptance.md) |
...
[acceptance criteria](WP-121_hypercare_stabilization.acceptance.md) reaches the decision — issuance is not acceptance.
