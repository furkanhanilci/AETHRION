...
| Companion | [test procedures](WP-105_vertical_slice_review_repro.tests.md) |
...
Each criterion names the test case in [`WP-105_vertical_slice_review_repro.tests.md`](WP-105_vertical_slice_review_repro.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
