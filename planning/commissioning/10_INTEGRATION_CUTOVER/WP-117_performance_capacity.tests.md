...
| Companion | [acceptance criteria](WP-117_performance_capacity.acceptance.md) |
...
[acceptance criteria](WP-117_performance_capacity.acceptance.md) reaches the decision — issuance is not acceptance.
