# WP-109 — Acceptance Scenario Registry and Harness — Acceptance Criteria
...
| Companion | [test procedures](WP-109_acceptance_registry.tests.md) |
...
Each criterion names the test case in [`WP-109_acceptance_registry.tests.md`](WP-109_acceptance_registry.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
