...
| Work package | [`WP-107` — Engineering Vertical Slice — Spec, Worktree, Signed Release](WP-107_engineering_vertical_slice.md) |
| Companion | [test procedures](WP-107_engineering_vertical_slice.tests.md) |
...
Each criterion names the test case in [`WP-107_engineering_vertical_slice.tests.md`](WP-107_engineering_vertical_slice.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
