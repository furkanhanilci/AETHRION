...
| Work package | [`WP-119` — Controlled Pilot and Cutover Rehearsal](WP-119_pilot_cutover_rehearsal.md) |
| Companion | [test procedures](WP-119_pilot_cutover_rehearsal.tests.md) |
...
Each criterion names the test case in [`WP-119_pilot_cutover_rehearsal.tests.md`](WP-119_pilot_cutover_rehearsal.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
