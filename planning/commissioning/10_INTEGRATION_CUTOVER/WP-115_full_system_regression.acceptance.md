...
| Companion | [test procedures](WP-115_full_system_regression.tests.md) |
...
Each criterion names the test case in [`WP-115_full_system_regression.tests.md`](WP-115_full_system_regression.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
