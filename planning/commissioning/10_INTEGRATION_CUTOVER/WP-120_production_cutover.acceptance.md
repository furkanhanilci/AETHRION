...
| Work package | [`WP-120` — Production Cutover and Go-Live Decision](WP-120_production_cutover.md) |
| Companion | [test procedures](WP-120_production_cutover.tests.md) |
...
Each criterion names the test case in [`WP-120_production_cutover.tests.md`](WP-120_production_cutover.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
