...
| Work package | [`WP-103` — Vertical Slice 2 — Two-Way Literature and Set Freeze](WP-103_vertical_slice_literature.md) |
| Companion | [acceptance criteria](WP-103_vertical_slice_literature.acceptance.md) |
...
| C12 | Agent-Used Source Write-Back | [ACC-02](../12_ACCEPTANCE_SCENARIOS/ACC-02_agent_used_source_writeback.md) — Critical | *(name the test case)* |
| C13 | Duplicate and Metadata Collision | [ACC-03](../12_ACCEPTANCE_SCENARIOS/ACC-03_duplicate_collision.md) — High | *(name the test case)* |
| C14 | Prompt-Injection PDF | [ACC-05](../12_ACCEPTANCE_SCENARIOS/ACC-05_prompt_injection_pdf.md) — Critical | *(name the test case)* |
| C15 | Zotero Full Resync | [ACC-28](../12_ACCEPTANCE_SCENARIOS/ACC-28_zotero_full_resync.md) — High | *(name the test case)* |
...
[acceptance criteria](WP-103_vertical_slice_literature.acceptance.md) reaches the decision — issuance is not acceptance.
