...
| Work package | [`WP-106` — Vertical Slice 5 — Human Decision, Publish and Monitor](WP-106_vertical_slice_decision_publish_monitor.md) |
| Companion | [acceptance criteria](WP-106_vertical_slice_decision_publish_monitor.acceptance.md) |
...
| C12 | Retraction Impact | [ACC-04](../12_ACCEPTANCE_SCENARIOS/ACC-04_retraction_impact.md) — Critical | *(name the test case)* |
| C13 | Human Approval Forgery | [ACC-25](../12_ACCEPTANCE_SCENARIOS/ACC-25_human_approval_forgery.md) — Critical | *(name the test case)* |
...
| C16 | Model Snapshot Drift | [ACC-36](../12_ACCEPTANCE_SCENARIOS/ACC-36_model_snapshot_drift.md) — Critical | *(name the test case)* |
| C17 | Complete Project Audit Export | [ACC-40](../12_ACCEPTANCE_SCENARIOS/ACC-40_audit_export.md) — Critical | *(name the test case)* |
| C18 | Claimless Publication Assertion | [ACC-52](../12_ACCEPTANCE_SCENARIOS/ACC-52_claimless_publication_assertion.md) — Critical | *(name the test case)* |
| C19 | Unverified Numeric Result | [ACC-53](../12_ACCEPTANCE_SCENARIOS/ACC-53_unverified_numeric_result.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-106_vertical_slice_decision_publish_monitor.acceptance.md) reaches the decision — issuance is not acceptance.
