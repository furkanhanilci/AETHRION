...
| Companion | [test procedures](WP-106_vertical_slice_decision_publish_monitor.tests.md) |
...
Each criterion names the test case in [`WP-106_vertical_slice_decision_publish_monitor.tests.md`](WP-106_vertical_slice_decision_publish_monitor.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
