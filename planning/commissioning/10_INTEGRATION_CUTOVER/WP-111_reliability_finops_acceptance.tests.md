...
| C13 | Duplicate Event Delivery | [ACC-12](../12_ACCEPTANCE_SCENARIOS/ACC-12_duplicate_event.md) — Critical | *(name the test case)* |
...
| C16 | Provider Invoice Variance | [ACC-29](../12_ACCEPTANCE_SCENARIOS/ACC-29_invoice_variance.md) — Medium | *(name the test case)* |
| C17 | Kueue Preemption | [ACC-33](../12_ACCEPTANCE_SCENARIOS/ACC-33_kueue_preemption.md) — High | *(name the test case)* |
| C18 | DLQ Repair and Corrected Replay | [ACC-34](../12_ACCEPTANCE_SCENARIOS/ACC-34_dlq_repair.md) — High | *(name the test case)* |
| C19 | Tool Partial Failure | [ACC-35](../12_ACCEPTANCE_SCENARIOS/ACC-35_tool_partial_failure.md) — Critical | *(name the test case)* |
