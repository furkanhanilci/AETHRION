...
| Companion | [test procedures](WP-103_vertical_slice_literature.tests.md) |
...
Each criterion names the test case in [`WP-103_vertical_slice_literature.tests.md`](WP-103_vertical_slice_literature.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
