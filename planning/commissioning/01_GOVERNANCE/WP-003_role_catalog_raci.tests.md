...
| Companion | [acceptance criteria](WP-003_role_catalog_raci.acceptance.md) |
...
[acceptance criteria](WP-003_role_catalog_raci.acceptance.md) reaches the decision — issuance is not acceptance.
