...
| Companion | [test procedures](WP-006_execution_profile.tests.md) |
...
Each criterion names the test case in [`WP-006_execution_profile.tests.md`](WP-006_execution_profile.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
