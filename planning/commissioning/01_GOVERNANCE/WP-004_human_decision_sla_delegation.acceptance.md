...
| Companion | [test procedures](WP-004_human_decision_sla_delegation.tests.md) |
...
Each criterion names the test case in [`WP-004_human_decision_sla_delegation.tests.md`](WP-004_human_decision_sla_delegation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
