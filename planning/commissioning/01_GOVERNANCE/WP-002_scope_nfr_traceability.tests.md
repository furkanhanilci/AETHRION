...
| Companion | [acceptance criteria](WP-002_scope_nfr_traceability.acceptance.md) |
...
[acceptance criteria](WP-002_scope_nfr_traceability.acceptance.md) reaches the decision — issuance is not acceptance.
