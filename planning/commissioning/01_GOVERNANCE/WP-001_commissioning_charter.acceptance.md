...
| Companion | [test procedures](WP-001_commissioning_charter.tests.md) |
...
Each criterion names the test case in [`WP-001_commissioning_charter.tests.md`](WP-001_commissioning_charter.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
