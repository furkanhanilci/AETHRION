...
| Companion | [acceptance criteria](WP-008_gate_policy_g0_g10.acceptance.md) |
...
| C11 | Confirmatory Result Without a Frozen Analysis Plan | [ACC-56](../12_ACCEPTANCE_SCENARIOS/ACC-56_confirmatory_without_frozen_plan.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-008_gate_policy_g0_g10.acceptance.md) reaches the decision — issuance is not acceptance.
