...
| Companion | [acceptance criteria](WP-007_independence_profile.acceptance.md) |
...
| C14 | Reproduction in the Producer Environment | [ACC-65](../12_ACCEPTANCE_SCENARIOS/ACC-65_reproduction_in_producer_environment.md) — Critical | *(name the test case)* |
| C15 | Reviewer Isolation Before Review Lock | [ACC-72](../12_ACCEPTANCE_SCENARIOS/ACC-72_reviewer_isolation_before_lock.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-007_independence_profile.acceptance.md) reaches the decision — issuance is not acceptance.
