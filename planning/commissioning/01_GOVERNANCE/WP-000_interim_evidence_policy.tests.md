...
| Work package | [`WP-000` — Interim Evidence Policy and Attestation Bootstrap](WP-000_interim_evidence_policy.md) |
| Companion | [acceptance criteria](WP-000_interim_evidence_policy.acceptance.md) |
...
| C07 | Planner Self-Approval Attempt | [ACC-06](../12_ACCEPTANCE_SCENARIOS/ACC-06_plan_self_approval.md) — Critical | *(name the test case)* |
...
[acceptance criteria](WP-000_interim_evidence_policy.acceptance.md) reaches the decision — issuance is not acceptance.
