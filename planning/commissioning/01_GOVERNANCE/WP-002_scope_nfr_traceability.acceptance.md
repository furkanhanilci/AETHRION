...
| Work package | [`WP-002` — Scope, NFRs and Requirement Traceability](WP-002_scope_nfr_traceability.md) |
| Companion | [test procedures](WP-002_scope_nfr_traceability.tests.md) |
...
Each criterion names the test case in [`WP-002_scope_nfr_traceability.tests.md`](WP-002_scope_nfr_traceability.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
