...
| Companion | [test procedures](WP-009_control_exception_catalog.tests.md) |
...
Each criterion names the test case in [`WP-009_control_exception_catalog.tests.md`](WP-009_control_exception_catalog.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
