...
| Work package | [`WP-128` — Incident, Postmortem and Learning Closure](WP-128_incident_learning.md) |
| Companion | [test procedures](WP-128_incident_learning.tests.md) |
...
Each criterion names the test case in [`WP-128_incident_learning.tests.md`](WP-128_incident_learning.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
