...
| Work package | [`WP-127` — FinOps, Capacity and Portfolio Review Rhythm](WP-127_finops_portfolio.md) |
| Companion | [acceptance criteria](WP-127_finops_portfolio.acceptance.md) |
...
[acceptance criteria](WP-127_finops_portfolio.acceptance.md) reaches the decision — issuance is not acceptance.
