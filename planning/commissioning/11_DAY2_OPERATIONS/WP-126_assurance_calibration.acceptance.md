...
| Companion | [test procedures](WP-126_assurance_calibration.tests.md) |
...
Each criterion names the test case in [`WP-126_assurance_calibration.tests.md`](WP-126_assurance_calibration.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
