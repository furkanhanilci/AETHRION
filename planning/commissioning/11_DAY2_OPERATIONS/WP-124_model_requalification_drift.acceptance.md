...
| Companion | [test procedures](WP-124_model_requalification_drift.tests.md) |
...
Each criterion names the test case in [`WP-124_model_requalification_drift.tests.md`](WP-124_model_requalification_drift.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
