...
| Companion | [acceptance criteria](WP-130_architecture_continuous_assurance.acceptance.md) |
...
| C13 | Upstream Assimilation Drift | [ACC-73](../12_ACCEPTANCE_SCENARIOS/ACC-73_upstream_assimilation_drift.md) — High | *(name the test case)* |
| C14 | Governed Versus Ungoverned Research Harness | [ACC-80](../12_ACCEPTANCE_SCENARIOS/ACC-80_governed_versus_ungoverned_harness.md) — Medium | *(name the test case)* |
...
[acceptance criteria](WP-130_architecture_continuous_assurance.acceptance.md) reaches the decision — issuance is not acceptance.
