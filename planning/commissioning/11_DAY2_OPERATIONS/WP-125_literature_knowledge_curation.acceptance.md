...
| Companion | [test procedures](WP-125_literature_knowledge_curation.tests.md) |
...
Each criterion names the test case in [`WP-125_literature_knowledge_curation.tests.md`](WP-125_literature_knowledge_curation.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
