...
| Companion | [test procedures](WP-127_finops_portfolio.tests.md) |
...
Each criterion names the test case in [`WP-127_finops_portfolio.tests.md`](WP-127_finops_portfolio.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
