...
- Bağımlılıklar kabul edilmiştir: [WP-110 — Araştırma ve Literatür Kabul Paketi](../10_INTEGRATION_CUTOVER/WP-110_research_acceptance.md), [WP-111 — Reliability, Event ve FinOps Kabul Paketi](../10_INTEGRATION_CUTOVER/WP-111_reliability_finops_acceptance.md), [WP-112 — Security ve Privacy Kabul Paketi](../10_INTEGRATION_CUTOVER/WP-112_security_privacy_acceptance.md), [WP-113 — Evidence, Reproduction ve Publication Kabul Paketi](../10_INTEGRATION_CUTOVER/WP-113_evidence_repro_acceptance.md), [WP-114 — Operations, DR ve Restore Kabul Paketi](../10_INTEGRATION_CUTOVER/WP-114_operations_dr_acceptance.md)
