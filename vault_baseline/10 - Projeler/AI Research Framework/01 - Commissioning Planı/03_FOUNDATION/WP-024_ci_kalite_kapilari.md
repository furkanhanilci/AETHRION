...
- Bağımlılıklar kabul edilmiştir: [WP-020 — Schema Registry, Compatibility ve Contract SDK](../02_CONTRACTS/WP-020_schema_registry_sdk.md), [WP-022 — Repository Topolojisi ve Kod Sahipliği](../03_FOUNDATION/WP-022_repository_topolojisi.md), [WP-023 — Git, Worktree ve Protected Path Politikası](../03_FOUNDATION/WP-023_git_worktree_branch_policy.md)
