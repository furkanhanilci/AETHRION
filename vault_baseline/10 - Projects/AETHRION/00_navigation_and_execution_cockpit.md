...
obsidian_plan_root: 10 - Projects/AETHRION/01 - Commissioning
...
> [[10 - Projects/AETHRION/03 - Implementation/session_handover_2026-08-22|Session Handover — 2026-08-22]] — where the last session stopped, what is verified, what is
...
> [[10 - Projects/AETHRION/aethrion_current_status_and_roadmap|Current Status and Roadmap]],
...
- The Obsidian mirror: `10 - Projects/AETHRION/01 - Commissioning/`.
...
| Area | Content | Index |
|---|---|---|
| `01 - Commissioning/` | The WP-001–140, ACC-01–40 plan mirror | [[10 - Projects/AETHRION/01 - Commissioning/commissioning_index\|Commissioning Index]] |
| `02 - Reviews/` | Independent review instructions and results | [[10 - Projects/AETHRION/02 - Reviews/reviews_index\|Reviews Index]] |
| `03 - Implementation/` | Implementation steps | [[10 - Projects/AETHRION/03 - Implementation/implementation_index\|Implementation Index]] |
| `04 - Architecture/` | Target architecture and maps | [[10 - Projects/AETHRION/04 - Architecture/architecture_index\|Architecture Index]] |
| `05 - Evidence/` | Test, hash and acceptance evidence | [[10 - Projects/AETHRION/05 - Evidence/evidence_index\|Evidence Index]] |
| `06 - Components/` | Component status | [[10 - Projects/AETHRION/06 - Components/components_index\|Components Index]] |
| **`07 - Skills/`** | **52 skills** — engineering · scientific · shared · reporting | [[10 - Projects/AETHRION/07 - Skills/skills_index\|Skills Index]] |

## Framework visibility map

- [[10 - Projects/AETHRION/04 - Architecture/framework_repository_and_obsidian_map|Repository and Obsidian Map]] — the central map of every framework area
- [[10 - Projects/AETHRION/02 - Reviews/claude_full_framework_review_prompt|Full Framework Review Prompt]] — an independent review instruction not limited to the Bridge
- [[10 - Projects/AETHRION/06 - Components/Bridge/bridge_component_status|Bridge Component Status]] — the Bridge's real boundary within the framework
- [[10 - Projects/AETHRION/03 - Implementation/implementation_index|Implementation Records]] — the project view of implementation steps
...
- [[10 - Projects/AETHRION/02 - Reviews/claude_framework_audit_report|Claude Framework Audit Report]] — the evidence-based independent audit of the current implementation; the WP/ACC status distribution, the risk register and the roadmap
- [[10 - Projects/AETHRION/04 - Architecture/aethrion_ideal_structure|AETHRION Ideal Structure]] — **what** should be added: the added roles, review mechanisms, the 7th plane (Metascience & Calibration), the role→model assignment and the tool stack
- [[10 - Projects/AETHRION/04 - Architecture/aethrion_skill_layer|AETHRION Skill Layer]] — **how** it should be executed: full `obra/superpowers` integration; the Skill Registry, iron laws, rationalisation tables, the escalation ladder and `ProducerResponse`
- [[10 - Projects/AETHRION/04 - Architecture/aethrion_role_model_assignment|Role → Model Assignment]] — **who** executes: human / model / deterministic code; the model pool, the effort→R mapping and the snapshot-pinning constraint
- [[10 - Projects/AETHRION/07 - Skills/skills_index|Skills Index]] — the 52 skills in two families plus the shared core
...
1. [[10 - Projects/AETHRION/01 - Commissioning/commissioning_index|Commissioning Index]]
2. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/00_how_to_use_this_plan|How to Use This Plan]]
3. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/01_target_state_and_invariants|Target State and Invariants]]
4. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/02_wave_and_dependency_map|Wave and Dependency Map]]
5. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/03_package_catalogue|Package Catalogue]]
6. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/05_definition_of_ready_and_done|Definition of Ready / Done]]
7. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/06_evidence_and_acceptance_strategy|Evidence and Acceptance Strategy]]
8. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/07_programme_risk_register|Programme Risk Register]]
9. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/09_change_and_configuration_control|Change and Configuration Control]]
10. [[10 - Projects/AETHRION/01 - Commissioning/00_PROGRAM/11_scope_coverage_matrix|Scope Coverage Matrix]]
