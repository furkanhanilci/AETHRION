---
title: "ADR-014 — One Canonical Authority Per Kind of State"
aliases:
  - "ADR-014"
cssclasses:
...
status: ACCEPTED
summary: "A system with a workflow engine, a relational store, an object store, an event bus, a graph projection, a vector index and two human workspaces has seven plausible answers to \"where does this live?\"."
source: "docs/architecture/ADR-014_canonical_authority_and_split_brain.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-014_canonical_authority_and_split_brain.md` in the repository. Edit the
