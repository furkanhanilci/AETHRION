---
title: "ADR-008 — Verification Taxonomy V0–V3 and Verifier Qualification"
aliases:
  - "ADR-008"
cssclasses:
...
status: ACCEPTED
summary: "This system's thesis is agents produce, machines verify, humans decide."
source: "docs/architecture/ADR-008_verification_taxonomy.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-008_verification_taxonomy.md` in the repository. Edit the
...
Both are decided by [`ADR-015`](adr_015_adaptive_assurance_routing.md): assurance
