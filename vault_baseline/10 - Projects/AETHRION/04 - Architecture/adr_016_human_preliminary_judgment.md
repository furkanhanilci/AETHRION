---
title: "ADR-016 — The Human Judges Before the Machine Recommends"
aliases:
  - "ADR-016"
cssclasses:
...
status: ACCEPTED
summary: "\"Humans decide\" is the third clause of this system's thesis, and it is the one most easily satisfied on paper and lost in practice."
source: "docs/architecture/ADR-016_human_preliminary_judgment.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-016_human_preliminary_judgment.md` in the repository. Edit the
