---
title: "ADR-017 — A Benchmark Run Is Firewalled, and Contamination Is a Label"
aliases:
  - "ADR-017"
cssclasses:
...
status: ACCEPTED
summary: "This architecture leans on external benchmarks — they are the door external truth comes through, and the register names a dozen."
source: "docs/architecture/ADR-017_benchmark_isolation.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-017_benchmark_isolation.md` in the repository. Edit the
