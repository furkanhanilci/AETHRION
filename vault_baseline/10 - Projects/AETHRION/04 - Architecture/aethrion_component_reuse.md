...
> **Neither engine is chosen — [`ADR-010`](adr_010_policy_backend.md).** This
...
- **Assimilated mechanisms and their upstreams: [`provenance/README.md`](upstream_lineage_register.md)**, generated from `provenance/upstreams.json`
