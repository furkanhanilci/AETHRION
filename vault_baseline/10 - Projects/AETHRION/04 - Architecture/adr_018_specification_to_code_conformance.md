---
title: "ADR-018 — Frozen Specification and Running Code Must Still Agree"
aliases:
  - "ADR-018"
cssclasses:
...
status: ACCEPTED
summary: "A protocol is frozen at G2 and the code is written afterwards."
source: "docs/architecture/ADR-018_specification_to_code_conformance.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-018_specification_to_code_conformance.md` in the repository. Edit the
