---
title: "ADR-004 — Mechanism Assimilation and Upstream Lineage"
aliases:
  - "ADR-004"
cssclasses:
...
status: ACCEPTED
summary: "Most of what a research system needs has been solved somewhere before — a candidate search tree, a budget governor, an artifact lineage graph, a review state machine."
source: "docs/architecture/ADR-004_mechanism_assimilation.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-004_mechanism_assimilation.md` in the repository. Edit the
...
[`ADR-019`](adr_019_supply_chain_and_upstream_standard.md) decides both: SPDX and
