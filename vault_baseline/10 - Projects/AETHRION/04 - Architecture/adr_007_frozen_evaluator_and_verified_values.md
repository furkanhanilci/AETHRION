---
title: "ADR-007 — Frozen Evaluators and Verified Values"
aliases:
  - "ADR-007"
cssclasses:
...
status: ACCEPTED
summary: "A system that optimises a metric will optimise whatever is easiest to move, and the easiest thing to move is usually the metric."
source: "docs/architecture/ADR-007_frozen_evaluator_and_verified_values.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-007_frozen_evaluator_and_verified_values.md` in the repository. Edit the
