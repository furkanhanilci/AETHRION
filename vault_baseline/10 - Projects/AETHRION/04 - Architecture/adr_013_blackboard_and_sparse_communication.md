---
title: "ADR-013 — The Blackboard Is a Projection, and the Topology Is Sparse by Default"
aliases:
  - "ADR-013"
cssclasses:
...
status: ACCEPTED
summary: "Keeping a cohort (ADR-011) means paying for its conversation, and a naive cohort talks to itself quadratically: every agent to every agent, every round, carrying full reasoning transcripts."
source: "docs/architecture/ADR-013_blackboard_and_sparse_communication.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-013_blackboard_and_sparse_communication.md` in the repository. Edit the
