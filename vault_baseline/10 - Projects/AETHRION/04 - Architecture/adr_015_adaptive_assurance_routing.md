---
title: "ADR-015 — Assurance Is Routed by Risk and Uncertainty, and a Verifier May Abstain"
aliases:
  - "ADR-015"
cssclasses:
...
status: ACCEPTED
summary: "ADR-008 fixed what verification is — four classes, and a semantic verifier that cannot satisfy a requirement without a current qualification."
source: "docs/architecture/ADR-015_adaptive_assurance_routing.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-015_adaptive_assurance_routing.md` in the repository. Edit the
