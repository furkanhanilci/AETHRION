---
title: "ADR-005 — Epistemic Memory Separation"
aliases:
  - "ADR-005"
cssclasses:
...
status: ACCEPTED
summary: "The default design for an agent system is one long-term memory: write everything the agent might later need into a vector store and retrieve by similarity."
source: "docs/architecture/ADR-005_epistemic_memory_separation.md"
generated: true
...
> [!info] Generated view
> This note is generated from `docs/architecture/ADR-005_epistemic_memory_separation.md` in the repository. Edit the
