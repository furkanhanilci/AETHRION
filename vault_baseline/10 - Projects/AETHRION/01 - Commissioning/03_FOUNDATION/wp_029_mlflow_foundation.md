---
title: "WP-029 — MLflow Experiment and Evaluation Tracking Foundation"
aliases:
  - "WP-029"
...
status: NOT_STARTED
summary: "Experiment, evaluation, metric and artifact references are tracked under data-class-compliant, access-controlled, immutable run identities."
source: "planning/commissioning/03_FOUNDATION/WP-029_mlflow_foundation.md"
generated: true
...
| [Test procedures](wp_029_mlflow_foundation.tests.md) | How is it tested, in what environment, with what data, and what counts as a complete run? | The implementer and the tester |
| [Acceptance criteria](wp_029_mlflow_foundation.acceptance.md) | What must hold for this to be `ACCEPTED`, and what does it still not establish? | The independent verifier |
...
The outline below is the summary. The executable procedure — environment, data, coverage items, cases, execution log, incident and completion reports — is in [`WP-029_mlflow_foundation.tests.md`](wp_029_mlflow_foundation.tests.md).
...
The programme-level conditions are below. The package-specific, measurable criteria — each with a threshold and the test case that decides it — are in [`WP-029_mlflow_foundation.acceptance.md`](wp_029_mlflow_foundation.acceptance.md), together with what this package still cannot establish.
