...
status: NOT_STARTED
source: "planning/commissioning/03_FOUNDATION/WP-024_ci_quality_gates.tests.md"
generated: false
...
| Work package | [`WP-024` — CI Foundation and Deterministic Quality Gates](wp_024_ci_quality_gates.md) |
| Companion | [acceptance criteria](wp_024_ci_quality_gates.acceptance.md) |
...
| C12 | Missing Upstream Lineage or Licence | [ACC-74](../12_ACCEPTANCE_SCENARIOS/acc_74_missing_upstream_lineage.md) — High | *(name the test case)* |
...
[acceptance criteria](wp_024_ci_quality_gates.acceptance.md) reaches the decision — issuance is not acceptance.
