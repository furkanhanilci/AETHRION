...
status: NOT_STARTED
source: "planning/commissioning/03_FOUNDATION/WP-024_ci_quality_gates.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_024_ci_quality_gates.tests.md) |
...
Each criterion names the test case in [`WP-024_ci_quality_gates.tests.md`](wp_024_ci_quality_gates.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
