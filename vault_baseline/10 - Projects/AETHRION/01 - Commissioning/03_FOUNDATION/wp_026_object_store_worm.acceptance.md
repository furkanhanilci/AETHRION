...
status: NOT_STARTED
source: "planning/commissioning/03_FOUNDATION/WP-026_object_store_worm.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_026_object_store_worm.tests.md) |
...
Each criterion names the test case in [`WP-026_object_store_worm.tests.md`](wp_026_object_store_worm.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
