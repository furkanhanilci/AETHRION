---
title: "WP-146 — Epistemic Memory Taxonomy and Retention — Acceptance Criteria"
aliases:
  - "WP-146 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/14_SCIENTIFIC_INTELLIGENCE/WP-146_epistemic_memory_taxonomy.acceptance.md"
generated: false
...
| Work package | [`WP-146` — Epistemic Memory Taxonomy and Retention](wp_146_epistemic_memory_taxonomy.md) |
| Companion | [test procedures](wp_146_epistemic_memory_taxonomy.tests.md) |
...
Each criterion names the test case in [`WP-146_epistemic_memory_taxonomy.tests.md`](wp_146_epistemic_memory_taxonomy.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
