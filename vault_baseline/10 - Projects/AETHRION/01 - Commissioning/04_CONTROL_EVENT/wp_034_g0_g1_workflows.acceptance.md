...
status: NOT_STARTED
source: "planning/commissioning/04_CONTROL_EVENT/WP-034_g0_g1_workflows.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_034_g0_g1_workflows.tests.md) |
...
Each criterion names the test case in [`WP-034_g0_g1_workflows.tests.md`](wp_034_g0_g1_workflows.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
