...
status: NOT_STARTED
source: "planning/commissioning/04_CONTROL_EVENT/WP-032_project_lifecycle_skeleton.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_032_project_lifecycle_skeleton.acceptance.md) |
...
| C11 | Temporal Worker Crash | [ACC-13](../12_ACCEPTANCE_SCENARIOS/acc_13_temporal_worker_crash.md) — Critical | *(name the test case)* |
| C12 | Workflow Code Deployment and Replay | [ACC-14](../12_ACCEPTANCE_SCENARIOS/acc_14_workflow_code_deploy.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_032_project_lifecycle_skeleton.acceptance.md) reaches the decision — issuance is not acceptance.
