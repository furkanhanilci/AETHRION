---
title: "WP-033 — Gate Service and GateRecord Evaluation — Acceptance Criteria"
aliases:
  - "WP-033 acceptance"
type: acceptance-criteria
category: commissioning
status: NOT_STARTED
source: "planning/commissioning/04_CONTROL_EVENT/WP-033_gate_service_records.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_033_gate_service_records.tests.md) |
...
Each criterion names the test case in [`WP-033_gate_service_records.tests.md`](wp_033_gate_service_records.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
