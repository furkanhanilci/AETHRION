...
status: NOT_STARTED
source: "planning/commissioning/02_CONTRACTS/WP-015_event_envelope_taxonomy.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_015_event_envelope_taxonomy.acceptance.md) |
...
| C10 | Duplicate Event Delivery | [ACC-12](../12_ACCEPTANCE_SCENARIOS/acc_12_duplicate_event.md) — Critical | *(name the test case)* |
| C11 | DLQ Repair and Corrected Replay | [ACC-34](../12_ACCEPTANCE_SCENARIOS/acc_34_dlq_repair.md) — High | *(name the test case)* |
...
[acceptance criteria](wp_015_event_envelope_taxonomy.acceptance.md) reaches the decision — issuance is not acceptance.
