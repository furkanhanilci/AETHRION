...
status: NOT_STARTED
source: "planning/commissioning/02_CONTRACTS/WP-011_identity_correlation_standard.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_011_identity_correlation_standard.tests.md) |
...
Each criterion names the test case in [`WP-011_identity_correlation_standard.tests.md`](wp_011_identity_correlation_standard.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
