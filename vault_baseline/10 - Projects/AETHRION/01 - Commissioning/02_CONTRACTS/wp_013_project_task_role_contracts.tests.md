---
title: "WP-013 — Project, Task, Role and Skill Contract Schemas — Test Procedures"
aliases:
  - "WP-013 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/02_CONTRACTS/WP-013_project_task_role_contracts.tests.md"
generated: false
...
| Work package | [`WP-013` — Project, Task, Role and Skill Contract Schemas](wp_013_project_task_role_contracts.md) |
| Companion | [acceptance criteria](wp_013_project_task_role_contracts.acceptance.md) |
...
| C14 | Task Runs With No Skill Loaded | [ACC-46](../12_ACCEPTANCE_SCENARIOS/acc_46_skill_not_loaded.md) — Critical | *(name the test case)* |
| C15 | Wrong or Competing Skill Selected | [ACC-48](../12_ACCEPTANCE_SCENARIOS/acc_48_wrong_skill_selected.md) — High | *(name the test case)* |
| C16 | Upstream Change Invalidates a Derived Skill | [ACC-51](../12_ACCEPTANCE_SCENARIOS/acc_51_upstream_skill_drift.md) — High | *(name the test case)* |
...
[acceptance criteria](wp_013_project_task_role_contracts.acceptance.md) reaches the decision — issuance is not acceptance.
