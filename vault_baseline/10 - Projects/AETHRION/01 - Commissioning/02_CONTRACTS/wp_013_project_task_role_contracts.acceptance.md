---
title: "WP-013 — Project, Task, Role and Skill Contract Schemas — Acceptance Criteria"
aliases:
  - "WP-013 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/02_CONTRACTS/WP-013_project_task_role_contracts.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_013_project_task_role_contracts.tests.md) |
...
Each criterion names the test case in [`WP-013_project_task_role_contracts.tests.md`](wp_013_project_task_role_contracts.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
