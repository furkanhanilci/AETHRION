...
status: NOT_STARTED
source: "planning/commissioning/02_CONTRACTS/WP-014_artifact_manifest_contracts.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_014_artifact_manifest_contracts.tests.md) |
...
Each criterion names the test case in [`WP-014_artifact_manifest_contracts.tests.md`](wp_014_artifact_manifest_contracts.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
