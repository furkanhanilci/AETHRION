---
title: "WP-016 — PolicyDecision, Control and Exception Schemas — Acceptance Criteria"
aliases:
  - "WP-016 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/02_CONTRACTS/WP-016_policy_control_exception_contracts.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_016_policy_control_exception_contracts.tests.md) |
...
Each criterion names the test case in [`WP-016_policy_control_exception_contracts.tests.md`](wp_016_policy_control_exception_contracts.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
