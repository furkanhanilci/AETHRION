---
title: "WP-085 — Repeatability, Reproducibility, Robustness and Replication Pipeline — Acceptance Criteria"
aliases:
  - "WP-085 acceptance"
type: acceptance-criteria
category: commissioning
status: NOT_STARTED
source: "planning/commissioning/08_EVIDENCE_ASSURANCE/WP-085_repro_robustness_replication.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_085_repro_robustness_replication.tests.md) |
...
Each criterion names the test case in [`WP-085_repro_robustness_replication.tests.md`](wp_085_repro_robustness_replication.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
