---
title: "WP-088 — Blind, Cross-Family and Adversarial Review — Acceptance Criteria"
aliases:
  - "WP-088 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/08_EVIDENCE_ASSURANCE/WP-088_blind_cross_family_review.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_088_blind_cross_family_review.tests.md) |
...
Each criterion names the test case in [`WP-088_blind_cross_family_review.tests.md`](wp_088_blind_cross_family_review.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
