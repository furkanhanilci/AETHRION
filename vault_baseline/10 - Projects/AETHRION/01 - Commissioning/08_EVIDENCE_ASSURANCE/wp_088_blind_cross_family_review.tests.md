...
| C16 | Non-Waivable Skill Ignored Under Pressure | [ACC-49](../12_ACCEPTANCE_SCENARIOS/acc_49_skill_ignored_under_pressure.md) — Critical | *(name the test case)* |
| C17 | Reviewer Isolation Before Review Lock | [ACC-72](../12_ACCEPTANCE_SCENARIOS/acc_72_reviewer_isolation_before_lock.md) — Critical | *(name the test case)* |
| C18 | Sycophancy Anchor Attack | [ACC-089](../12_ACCEPTANCE_SCENARIOS/acc_089_sycophancy_anchor_attack.md) — Critical | *(name the test case)* |
