---
title: "WP-081 — Protocol, Analysis, Baseline and Falsification Registry — Test Procedures"
aliases:
  - "WP-081 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/08_EVIDENCE_ASSURANCE/WP-081_protocol_baseline_registry.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_081_protocol_baseline_registry.acceptance.md) |
...
| C13 | Confirmatory Result Without a Frozen Analysis Plan | [ACC-56](../12_ACCEPTANCE_SCENARIOS/acc_56_confirmatory_without_frozen_plan.md) — Critical | *(name the test case)* |
| C14 | Minor Specification Drift Is Recorded | [ACC-103](../12_ACCEPTANCE_SCENARIOS/acc_103_scientific_minor_spec_drift.md) — High | *(name the test case)* |
| C15 | Major Specification Drift Blocks Confirmatory Status | [ACC-104](../12_ACCEPTANCE_SCENARIOS/acc_104_scientific_major_spec_drift.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_081_protocol_baseline_registry.acceptance.md) reaches the decision — issuance is not acceptance.
