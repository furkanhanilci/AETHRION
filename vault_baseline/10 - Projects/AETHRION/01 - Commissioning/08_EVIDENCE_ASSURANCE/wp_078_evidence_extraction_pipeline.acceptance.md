...
status: NOT_STARTED
source: "planning/commissioning/08_EVIDENCE_ASSURANCE/WP-078_evidence_extraction_pipeline.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_078_evidence_extraction_pipeline.tests.md) |
...
Each criterion names the test case in [`WP-078_evidence_extraction_pipeline.tests.md`](wp_078_evidence_extraction_pipeline.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
