---
title: "WP-089 — DisagreementCase and Evidence-Weighted Arbitration — Acceptance Criteria"
aliases:
  - "WP-089 acceptance"
type: acceptance-criteria
category: commissioning
status: NOT_STARTED
source: "planning/commissioning/08_EVIDENCE_ASSURANCE/WP-089_disagreement_arbitration.acceptance.md"
generated: false
...
| Work package | [`WP-089` — DisagreementCase and Evidence-Weighted Arbitration](wp_089_disagreement_arbitration.md) |
| Companion | [test procedures](wp_089_disagreement_arbitration.tests.md) |
...
Each criterion names the test case in [`WP-089_disagreement_arbitration.tests.md`](wp_089_disagreement_arbitration.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
