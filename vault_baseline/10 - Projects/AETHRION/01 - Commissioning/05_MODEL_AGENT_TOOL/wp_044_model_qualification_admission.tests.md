...
| C16 | Unqualified Semantic Verifier | [ACC-61](../12_ACCEPTANCE_SCENARIOS/acc_61_unqualified_semantic_verifier.md) — Critical | *(name the test case)* |
| C17 | Expired Verifier Qualification | [ACC-107](../12_ACCEPTANCE_SCENARIOS/acc_107_expired_verifier_qualification.md) — Critical | *(name the test case)* |
| C18 | Verifier Abstention Is a Valid Result | [ACC-109](../12_ACCEPTANCE_SCENARIOS/acc_109_verifier_abstention_is_valid.md) — High | *(name the test case)* |
