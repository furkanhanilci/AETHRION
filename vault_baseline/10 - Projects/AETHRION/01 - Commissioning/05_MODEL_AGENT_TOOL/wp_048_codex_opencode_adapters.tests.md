...
| C20 | Task Runs With No Skill Loaded | [ACC-46](../12_ACCEPTANCE_SCENARIOS/acc_46_skill_not_loaded.md) — Critical | *(name the test case)* |
| C21 | Harness Starts Without the Skill Bootstrap | [ACC-47](../12_ACCEPTANCE_SCENARIOS/acc_47_skill_bootstrap_missing.md) — Critical | *(name the test case)* |
...
| C23 | Procedure Lost to Context Compaction or Restart | [ACC-50](../12_ACCEPTANCE_SCENARIOS/acc_50_skill_lost_on_compaction.md) — High | *(name the test case)* |
