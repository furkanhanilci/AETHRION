---
title: "WP-048 — Harness Runtime Adapters: Claude Code, Codex, OpenCode, Hermes and Direct Worker — Test Procedures"
aliases:
  - "WP-048 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/05_MODEL_AGENT_TOOL/WP-048_codex_opencode_adapters.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_048_codex_opencode_adapters.acceptance.md) |
...
| C19 | Task Runs With No Skill Loaded | [ACC-46](../12_ACCEPTANCE_SCENARIOS/acc_46_skill_not_loaded.md) — Critical | *(name the test case)* |
| C20 | Harness Starts Without the Skill Bootstrap | [ACC-47](../12_ACCEPTANCE_SCENARIOS/acc_47_skill_bootstrap_missing.md) — Critical | *(name the test case)* |
| C21 | Non-Waivable Skill Ignored Under Pressure | [ACC-49](../12_ACCEPTANCE_SCENARIOS/acc_49_skill_ignored_under_pressure.md) — Critical | *(name the test case)* |
| C22 | Procedure Lost to Context Compaction or Restart | [ACC-50](../12_ACCEPTANCE_SCENARIOS/acc_50_skill_lost_on_compaction.md) — High | *(name the test case)* |
...
[acceptance criteria](wp_048_codex_opencode_adapters.acceptance.md) reaches the decision — issuance is not acceptance.
