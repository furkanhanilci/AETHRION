---
title: "WP-148 — Multi-Agent Collaboration Plane and Cohort Integrity — Test Procedures"
aliases:
  - "WP-148 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/15_RELIABILITY_EFFICIENCY/WP-148_multi_agent_collaboration_plane.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_148_multi_agent_collaboration_plane.acceptance.md) |
...
| C19 | Multi-Agent Cohort Required | [ACC-081](../12_ACCEPTANCE_SCENARIOS/acc_081_multi_agent_cohort_required.md) — Critical | *(name the test case)* |
| C20 | Independent-First Embargo | [ACC-082](../12_ACCEPTANCE_SCENARIOS/acc_082_independent_first_embargo.md) — Critical | *(name the test case)* |
| C21 | Sycophancy Anchor Attack | [ACC-089](../12_ACCEPTANCE_SCENARIOS/acc_089_sycophancy_anchor_attack.md) — Critical | *(name the test case)* |
| C22 | False Consensus Cannot Close a Challenge | [ACC-090](../12_ACCEPTANCE_SCENARIOS/acc_090_false_consensus.md) — Critical | *(name the test case)* |
| C23 | Faulty Agent Output Does Not Propagate | [ACC-091](../12_ACCEPTANCE_SCENARIOS/acc_091_faulty_agent_challenge.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_148_multi_agent_collaboration_plane.acceptance.md) reaches the decision — issuance is not acceptance.
