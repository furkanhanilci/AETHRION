...
| C12 | Expired Verifier Qualification | [ACC-107](../12_ACCEPTANCE_SCENARIOS/acc_107_expired_verifier_qualification.md) — Critical | *(name the test case)* |
| C13 | Escalation Is Not Selective Enforcement | [ACC-108](../12_ACCEPTANCE_SCENARIOS/acc_108_selective_verifier_escalation.md) — Critical | *(name the test case)* |
| C14 | Verifier Abstention Is a Valid Result | [ACC-109](../12_ACCEPTANCE_SCENARIOS/acc_109_verifier_abstention_is_valid.md) — High | *(name the test case)* |
