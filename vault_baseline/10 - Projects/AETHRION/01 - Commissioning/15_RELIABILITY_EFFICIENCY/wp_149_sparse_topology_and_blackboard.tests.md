---
title: "WP-149 — Sparse Communication Topology and the Scientific Blackboard — Test Procedures"
aliases:
  - "WP-149 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/15_RELIABILITY_EFFICIENCY/WP-149_sparse_topology_and_blackboard.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_149_sparse_topology_and_blackboard.acceptance.md) |
...
| C15 | A Blackboard Entry Is Not Evidence | [ACC-085](../12_ACCEPTANCE_SCENARIOS/acc_085_blackboard_entry_is_not_evidence.md) — Critical | *(name the test case)* |
| C16 | Sparse Topology Preserves Quality | [ACC-086](../12_ACCEPTANCE_SCENARIOS/acc_086_sparse_topology_quality_preservation.md) — High | *(name the test case)* |
...
[acceptance criteria](wp_149_sparse_topology_and_blackboard.acceptance.md) reaches the decision — issuance is not acceptance.
