---
title: "WP-154 — Engineering Discipline and Specification Conformance — Acceptance Criteria"
aliases:
  - "WP-154 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/15_RELIABILITY_EFFICIENCY/WP-154_engineering_discipline_and_conformance.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_154_engineering_discipline_and_conformance.tests.md) |
...
Each criterion names the test case in [`WP-154_engineering_discipline_and_conformance.tests.md`](wp_154_engineering_discipline_and_conformance.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
