---
title: "WP-150 — Communication Governor, Edge Utility and Context Projection — Acceptance Criteria"
aliases:
  - "WP-150 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/15_RELIABILITY_EFFICIENCY/WP-150_communication_governor_and_context_projection.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_150_communication_governor_and_context_projection.tests.md) |
...
Each criterion names the test case in [`WP-150_communication_governor_and_context_projection.tests.md`](wp_150_communication_governor_and_context_projection.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
