---
title: "WP-151 — Memory Masking and Proactive Intervention — Test Procedures"
aliases:
  - "WP-151 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/15_RELIABILITY_EFFICIENCY/WP-151_memory_masking_and_intervention.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_151_memory_masking_and_intervention.acceptance.md) |
...
| C10 | A Refuted Memory Does Not Re-Enter Reasoning | [ACC-096](../12_ACCEPTANCE_SCENARIOS/acc_096_refuted_memory_mask.md) — High | *(name the test case)* |
| C11 | Proactive Reminder of a Frozen Constraint | [ACC-097](../12_ACCEPTANCE_SCENARIOS/acc_097_proactive_frozen_constraint_reminder.md) — High | *(name the test case)* |
| C12 | Memory Poisoning Attempt | [ACC-098](../12_ACCEPTANCE_SCENARIOS/acc_098_memory_poisoning_attempt.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_151_memory_masking_and_intervention.acceptance.md) reaches the decision — issuance is not acceptance.
