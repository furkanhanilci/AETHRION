---
title: "WP-154 — Engineering Discipline and Specification Conformance — Test Procedures"
aliases:
  - "WP-154 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/15_RELIABILITY_EFFICIENCY/WP-154_engineering_discipline_and_conformance.tests.md"
generated: false
...
| Work package | [`WP-154` — Engineering Discipline and Specification Conformance](wp_154_engineering_discipline_and_conformance.md) |
| Companion | [acceptance criteria](wp_154_engineering_discipline_and_conformance.acceptance.md) |
...
| C12 | Minor Specification Drift Is Recorded | [ACC-103](../12_ACCEPTANCE_SCENARIOS/acc_103_scientific_minor_spec_drift.md) — High | *(name the test case)* |
| C13 | Major Specification Drift Blocks Confirmatory Status | [ACC-104](../12_ACCEPTANCE_SCENARIOS/acc_104_scientific_major_spec_drift.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_154_engineering_discipline_and_conformance.acceptance.md) reaches the decision — issuance is not acceptance.
