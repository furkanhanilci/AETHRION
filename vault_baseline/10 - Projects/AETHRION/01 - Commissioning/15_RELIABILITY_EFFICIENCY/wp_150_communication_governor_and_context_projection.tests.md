...
| C11 | Sparse Topology Preserves Quality | [ACC-086](../12_ACCEPTANCE_SCENARIOS/acc_086_sparse_topology_quality_preservation.md) — High | *(name the test case)* |
| C12 | Communication Optimisation Rollback | [ACC-087](../12_ACCEPTANCE_SCENARIOS/acc_087_communication_optimization_rollback.md) — High | *(name the test case)* |
| C13 | Strategic Silence Never Silences a Blocker | [ACC-088](../12_ACCEPTANCE_SCENARIOS/acc_088_strategic_silence_never_silences_a_blocker.md) — Critical | *(name the test case)* |
