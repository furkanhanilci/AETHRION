---
title: "WP-130 — Architecture and Platform Continuous Assurance — Acceptance Criteria"
aliases:
  - "WP-130 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/11_DAY2_OPERATIONS/WP-130_architecture_continuous_assurance.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_130_architecture_continuous_assurance.tests.md) |
...
Each criterion names the test case in [`WP-130_architecture_continuous_assurance.tests.md`](wp_130_architecture_continuous_assurance.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
...
- [ ] `ACC-80` passes. A `SKIPPED` scenario on a Critical row does not count as a pass.
