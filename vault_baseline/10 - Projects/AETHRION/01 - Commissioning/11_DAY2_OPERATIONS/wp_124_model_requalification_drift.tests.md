...
status: NOT_STARTED
source: "planning/commissioning/11_DAY2_OPERATIONS/WP-124_model_requalification_drift.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_124_model_requalification_drift.acceptance.md) |
...
| C10 | Primary Model Provider Outage | [ACC-10](../12_ACCEPTANCE_SCENARIOS/acc_10_provider_outage.md) — High | *(name the test case)* |
| C11 | No Eligible Fallback | [ACC-11](../12_ACCEPTANCE_SCENARIOS/acc_11_no_eligible_fallback.md) — Critical | *(name the test case)* |
| C12 | Model Snapshot Drift | [ACC-36](../12_ACCEPTANCE_SCENARIOS/acc_36_model_snapshot_drift.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_124_model_requalification_drift.acceptance.md) reaches the decision — issuance is not acceptance.
