---
title: "WP-123 — Control Effectiveness and Policy Regression Rhythm — Acceptance Criteria"
aliases:
  - "WP-123 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/11_DAY2_OPERATIONS/WP-123_control_effectiveness.acceptance.md"
generated: false
...
| Work package | [`WP-123` — Control Effectiveness and Policy Regression Rhythm](wp_123_control_effectiveness.md) |
| Companion | [test procedures](wp_123_control_effectiveness.tests.md) |
...
Each criterion names the test case in [`WP-123_control_effectiveness.tests.md`](wp_123_control_effectiveness.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
