...
status: NOT_STARTED
source: "planning/commissioning/07_LITERATURE_KNOWLEDGE/WP-068_zotero_annotation_ingest.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_068_zotero_annotation_ingest.tests.md) |
...
Each criterion names the test case in [`WP-068_zotero_annotation_ingest.tests.md`](wp_068_zotero_annotation_ingest.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
