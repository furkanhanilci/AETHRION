...
status: NOT_STARTED
source: "planning/commissioning/07_LITERATURE_KNOWLEDGE/WP-062_source_identity_resolver.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_062_source_identity_resolver.tests.md) |
...
Each criterion names the test case in [`WP-062_source_identity_resolver.tests.md`](wp_062_source_identity_resolver.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
