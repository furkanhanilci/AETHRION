...
status: NOT_STARTED
source: "planning/commissioning/07_LITERATURE_KNOWLEDGE/WP-072_literature_manifest_freeze.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_072_literature_manifest_freeze.acceptance.md) |
...
| C14 | Retraction Impact | [ACC-04](../12_ACCEPTANCE_SCENARIOS/acc_04_retraction_impact.md) — Critical | *(name the test case)* |
...
| C16 | Literature Retrieval Budget and Stopping Rule | [ACC-75](../12_ACCEPTANCE_SCENARIOS/acc_75_retrieval_budget_and_stopping_rule.md) — High | *(name the test case)* |
...
[acceptance criteria](wp_072_literature_manifest_freeze.acceptance.md) reaches the decision — issuance is not acceptance.
