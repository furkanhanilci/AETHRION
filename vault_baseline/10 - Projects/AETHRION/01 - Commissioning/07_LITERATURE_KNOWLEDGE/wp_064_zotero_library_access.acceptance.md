...
status: NOT_STARTED
source: "planning/commissioning/07_LITERATURE_KNOWLEDGE/WP-064_zotero_library_access.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_064_zotero_library_access.tests.md) |
...
Each criterion names the test case in [`WP-064_zotero_library_access.tests.md`](wp_064_zotero_library_access.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
