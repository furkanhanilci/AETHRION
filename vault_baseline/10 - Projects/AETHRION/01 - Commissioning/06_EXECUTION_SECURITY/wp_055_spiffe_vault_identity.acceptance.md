...
status: NOT_STARTED
source: "planning/commissioning/06_EXECUTION_SECURITY/WP-055_spiffe_vault_identity.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_055_spiffe_vault_identity.tests.md) |
...
Each criterion names the test case in [`WP-055_spiffe_vault_identity.tests.md`](wp_055_spiffe_vault_identity.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
