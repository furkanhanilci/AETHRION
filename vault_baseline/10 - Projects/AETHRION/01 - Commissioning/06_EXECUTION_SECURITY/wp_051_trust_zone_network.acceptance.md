...
status: NOT_STARTED
source: "planning/commissioning/06_EXECUTION_SECURITY/WP-051_trust_zone_network.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_051_trust_zone_network.tests.md) |
...
Each criterion names the test case in [`WP-051_trust_zone_network.tests.md`](wp_051_trust_zone_network.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
