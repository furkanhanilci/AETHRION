---
title: "WP-052 — Kubernetes Cluster and Node Pool Baseline — Test Procedures"
aliases:
  - "WP-052 tests"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/06_EXECUTION_SECURITY/WP-052_kubernetes_cluster.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_052_kubernetes_cluster.acceptance.md) |
...
| C11 | Regional / Management Plane DR | [ACC-27](../12_ACCEPTANCE_SCENARIOS/acc_27_regional_dr.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_052_kubernetes_cluster.acceptance.md) reaches the decision — issuance is not acceptance.
