...
status: NOT_STARTED
source: "planning/commissioning/06_EXECUTION_SECURITY/WP-060_security_attack_suite.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_060_security_attack_suite.tests.md) |
...
Each criterion names the test case in [`WP-060_security_attack_suite.tests.md`](wp_060_security_attack_suite.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
