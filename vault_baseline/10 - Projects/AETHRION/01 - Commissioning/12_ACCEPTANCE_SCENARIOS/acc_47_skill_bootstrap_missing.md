...
source: "planning/commissioning/12_ACCEPTANCE_SCENARIOS/ACC-47_skill_bootstrap_missing.md"
generated: true
...
# ACC-47 — Harness Starts Without the Skill Bootstrap
...
- `ACC-47-result.json`: PASS/FAIL, the RC digest and the assertion results.
- `ACC-47-execution-log.jsonl`: time-ordered test, fault and decision records.
- `ACC-47-state-before.json` and `ACC-47-state-after.json`.
- `ACC-47-events.json`, `ACC-47-policy-decisions.json` and `ACC-47-audit-export.json`.
- `ACC-47-evidence-manifest.json`: the hash, producer and environment reference of every file.
