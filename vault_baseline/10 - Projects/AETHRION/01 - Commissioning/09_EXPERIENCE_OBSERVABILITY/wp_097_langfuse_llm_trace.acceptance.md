...
status: NOT_STARTED
source: "planning/commissioning/09_EXPERIENCE_OBSERVABILITY/WP-097_langfuse_llm_trace.acceptance.md"
generated: false
...
| Work package | [`WP-097` — Langfuse Model/Agent Tracing and Prompt Governance](wp_097_langfuse_llm_trace.md) |
| Companion | [test procedures](wp_097_langfuse_llm_trace.tests.md) |
...
Each criterion names the test case in [`WP-097_langfuse_llm_trace.tests.md`](wp_097_langfuse_llm_trace.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
