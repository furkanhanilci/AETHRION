...
status: NOT_STARTED
source: "planning/commissioning/09_EXPERIENCE_OBSERVABILITY/WP-091_lab_cockpit_shell.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_091_lab_cockpit_shell.tests.md) |
...
Each criterion names the test case in [`WP-091_lab_cockpit_shell.tests.md`](wp_091_lab_cockpit_shell.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
