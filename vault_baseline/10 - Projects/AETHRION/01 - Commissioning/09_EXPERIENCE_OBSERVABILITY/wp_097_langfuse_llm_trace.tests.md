...
status: NOT_STARTED
source: "planning/commissioning/09_EXPERIENCE_OBSERVABILITY/WP-097_langfuse_llm_trace.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_097_langfuse_llm_trace.acceptance.md) |
...
| C12 | Secret in Prompt or Trace | [ACC-32](../12_ACCEPTANCE_SCENARIOS/acc_32_secret_in_trace.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_097_langfuse_llm_trace.acceptance.md) reaches the decision — issuance is not acceptance.
