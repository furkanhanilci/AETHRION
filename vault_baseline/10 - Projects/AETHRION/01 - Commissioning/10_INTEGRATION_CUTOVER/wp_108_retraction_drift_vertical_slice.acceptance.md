...
status: NOT_STARTED
source: "planning/commissioning/10_INTEGRATION_CUTOVER/WP-108_retraction_drift_vertical_slice.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_108_retraction_drift_vertical_slice.tests.md) |
...
Each criterion names the test case in [`WP-108_retraction_drift_vertical_slice.tests.md`](wp_108_retraction_drift_vertical_slice.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
