...
status: NOT_STARTED
source: "planning/commissioning/10_INTEGRATION_CUTOVER/WP-111_reliability_finops_acceptance.tests.md"
generated: false
...
| Companion | [acceptance criteria](wp_111_reliability_finops_acceptance.acceptance.md) |
...
| C10 | Budget Hard Stop | [ACC-09](../12_ACCEPTANCE_SCENARIOS/acc_09_budget_hard_stop.md) — Critical | *(name the test case)* |
...
| C16 | Provider Invoice Variance | [ACC-29](../12_ACCEPTANCE_SCENARIOS/acc_29_invoice_variance.md) — Medium | *(name the test case)* |
| C17 | Kueue Preemption | [ACC-33](../12_ACCEPTANCE_SCENARIOS/acc_33_kueue_preemption.md) — High | *(name the test case)* |
| C18 | DLQ Repair and Corrected Replay | [ACC-34](../12_ACCEPTANCE_SCENARIOS/acc_34_dlq_repair.md) — High | *(name the test case)* |
| C19 | Tool Partial Failure | [ACC-35](../12_ACCEPTANCE_SCENARIOS/acc_35_tool_partial_failure.md) — Critical | *(name the test case)* |
...
[acceptance criteria](wp_111_reliability_finops_acceptance.acceptance.md) reaches the decision — issuance is not acceptance.
