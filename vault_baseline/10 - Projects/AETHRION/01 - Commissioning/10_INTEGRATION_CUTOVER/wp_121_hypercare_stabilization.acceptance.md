...
status: NOT_STARTED
source: "planning/commissioning/10_INTEGRATION_CUTOVER/WP-121_hypercare_stabilization.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_121_hypercare_stabilization.tests.md) |
...
Each criterion names the test case in [`WP-121_hypercare_stabilization.tests.md`](wp_121_hypercare_stabilization.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
