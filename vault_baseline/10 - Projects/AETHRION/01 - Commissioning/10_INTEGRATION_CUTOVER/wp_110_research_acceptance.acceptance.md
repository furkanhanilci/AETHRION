---
title: "WP-110 — Research and Literature Acceptance Package — Acceptance Criteria"
aliases:
  - "WP-110 acceptance"
cssclasses:
...
status: NOT_STARTED
source: "planning/commissioning/10_INTEGRATION_CUTOVER/WP-110_research_acceptance.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_110_research_acceptance.tests.md) |
...
Each criterion names the test case in [`WP-110_research_acceptance.tests.md`](wp_110_research_acceptance.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
