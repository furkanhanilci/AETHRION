...
status: NOT_STARTED
source: "planning/commissioning/10_INTEGRATION_CUTOVER/WP-118_operational_readiness.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_118_operational_readiness.tests.md) |
...
Each criterion names the test case in [`WP-118_operational_readiness.tests.md`](wp_118_operational_readiness.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
