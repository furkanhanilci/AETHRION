...
status: NOT_STARTED
source: "planning/commissioning/13_TOOLING_INTEGRATION/WP-138_external_records_persistent_identifiers.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_138_external_records_persistent_identifiers.tests.md) |
...
Each criterion names the test case in [`WP-138_external_records_persistent_identifiers.tests.md`](wp_138_external_records_persistent_identifiers.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
