...
status: NOT_STARTED
source: "planning/commissioning/13_TOOLING_INTEGRATION/WP-136_inbound_content_quarantine.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_136_inbound_content_quarantine.tests.md) |
...
Each criterion names the test case in [`WP-136_inbound_content_quarantine.tests.md`](wp_136_inbound_content_quarantine.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
