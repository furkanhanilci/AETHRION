---
title: "WP-001 — Commissioning Charter and Programme Authority"
aliases:
  - "WP-001"
...
status: NOT_STARTED
summary: "The programme's purpose, its production boundary, its funding authority, its decision bodies and the single-cutover rule are brought into force through a signed charter."
source: "planning/commissioning/01_GOVERNANCE/WP-001_commissioning_charter.md"
generated: true
...
| [Test procedures](wp_001_commissioning_charter.tests.md) | How is it tested, in what environment, with what data, and what counts as a complete run? | The implementer and the tester |
| [Acceptance criteria](wp_001_commissioning_charter.acceptance.md) | What must hold for this to be `ACCEPTED`, and what does it still not establish? | The independent verifier |
...
Neither register binds an upstream mechanism or a runtime component to `WP-001`, so every deliverable below is **`BUILD_NATIVE`**.
...
The outline below is the summary. The executable procedure — environment, data, coverage items, cases, execution log, incident and completion reports — is in [`WP-001_commissioning_charter.tests.md`](wp_001_commissioning_charter.tests.md).
...
The programme-level conditions are below. The package-specific, measurable criteria — each with a threshold and the test case that decides it — are in [`WP-001_commissioning_charter.acceptance.md`](wp_001_commissioning_charter.acceptance.md), together with what this package still cannot establish.
