---
title: "WP-007 — IndependenceProfile and Separation-of-Duties Policy"
aliases:
  - "WP-007"
...
status: NOT_STARTED
summary: "The separation of producer, reviewer and reproducer becomes auditable across seven dimensions: human, model family, context, credential, environment, data path and economic interest."
source: "planning/commissioning/01_GOVERNANCE/WP-007_independence_profile.md"
generated: true
...
| [Test procedures](wp_007_independence_profile.tests.md) | How is it tested, in what environment, with what data, and what counts as a complete run? | The implementer and the tester |
| [Acceptance criteria](wp_007_independence_profile.acceptance.md) | What must hold for this to be `ACCEPTED`, and what does it still not establish? | The independent verifier |
...
Neither register binds an upstream mechanism or a runtime component to `WP-007`, so every deliverable below is **`BUILD_NATIVE`**.
...
The outline below is the summary. The executable procedure — environment, data, coverage items, cases, execution log, incident and completion reports — is in [`WP-007_independence_profile.tests.md`](wp_007_independence_profile.tests.md).
...
The programme-level conditions are below. The package-specific, measurable criteria — each with a threshold and the test case that decides it — are in [`WP-007_independence_profile.acceptance.md`](wp_007_independence_profile.acceptance.md), together with what this package still cannot establish.
