...
status: NOT_STARTED
source: "planning/commissioning/01_GOVERNANCE/WP-007_independence_profile.acceptance.md"
generated: false
...
| Companion | [test procedures](wp_007_independence_profile.tests.md) |
...
Each criterion names the test case in [`WP-007_independence_profile.tests.md`](wp_007_independence_profile.tests.md) that decides it. A criterion with no test case cannot be verified, and a test case that decides no criterion is not part of acceptance.
