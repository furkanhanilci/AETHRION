...
| C13 | Critical Reviewer Unavailable | [ACC-38](../12_ACCEPTANCE_SCENARIOS/acc_38_reviewer_unavailable.md) — High | *(name the test case)* |
| C14 | Reproduction in the Producer Environment | [ACC-65](../12_ACCEPTANCE_SCENARIOS/acc_65_reproduction_in_producer_environment.md) — Critical | *(name the test case)* |
| C15 | Reviewer Isolation Before Review Lock | [ACC-72](../12_ACCEPTANCE_SCENARIOS/acc_72_reviewer_isolation_before_lock.md) — Critical | *(name the test case)* |
