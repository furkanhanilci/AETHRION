...
- Bağımlılıklar kabul edilmiştir: [WP-021 — Development, Staging ve Production Ortam Baseline'ı](../03_FOUNDATION/wp_021_environment_account_network_baseline.md), [WP-027 — Git, OCI Registry ve Build Provenance Temeli](../03_FOUNDATION/wp_027_git_oci_supply_chain.md), [WP-051 — Dört Trust Zone ve Ağ Segmentasyonu](../06_EXECUTION_SECURITY/wp_051_trust_zone_network.md)
