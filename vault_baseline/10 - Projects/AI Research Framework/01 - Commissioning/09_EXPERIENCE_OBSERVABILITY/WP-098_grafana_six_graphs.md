...
- Bağımlılıklar kabul edilmiştir: [WP-030 — Neo4j, pgvector ve OpenSearch Derived Read Models](../03_FOUNDATION/WP-030_derived_read_models.md), [WP-096 — OpenTelemetry Uçtan Uca Correlation Spine](../09_EXPERIENCE_OBSERVABILITY/WP-096_otel_correlation.md), [WP-097 — Langfuse Model/Agent Trace ve Prompt Governance](../09_EXPERIENCE_OBSERVABILITY/WP-097_langfuse_llm_trace.md)
