...
Bu matris, “bir bileşen veya yönetişim alanı plan dışında kaldı mı?” sorusunun hızlı denetimidir. Ayrıntılı bağımlılıklar `03_package_catalog.md` ve `paket_bagimlilik_matrisi.csv` içindedir.
