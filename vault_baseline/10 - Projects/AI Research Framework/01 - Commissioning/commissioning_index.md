...
Hiçbir paket varsayılan olarak L'den büyük olmamalıdır. Refinement sonunda L üstü çıkan paket bölünür. Tahmin takvim taahhüdü değildir; `00_PROGRAM/08_capacity_and_estimation.md` içindeki kapasite modeliyle tarihe çevrilir.

## 6. Çalışmaya başlama sırası

1. `00_PROGRAM/01_target_state_and_invariants.md` ile kapsamı okuyun.
2. `00_PROGRAM/02_wave_and_dependency_map.md` üzerinden geçerli dalgayı seçin.
3. `00_PROGRAM/03_package_catalog.md` içinden bağımlılıkları kapanmış paketi alın.
