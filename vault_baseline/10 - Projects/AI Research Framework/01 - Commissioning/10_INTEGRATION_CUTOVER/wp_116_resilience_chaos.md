...
- Bağımlılıklar kabul edilmiştir: [WP-040 — Workflow Replay, Versioning ve Failure Test Suite](../04_CONTROL_EVENT/wp_040_workflow_replay_failure_suite.md), [WP-060 — Agentic Security Attack Suite ve Red-Team Kabulü](../06_EXECUTION_SECURITY/wp_060_security_attack_suite.md), [WP-101 — Service Catalog, SLO ve Alert/Runbook Bağlama](../09_EXPERIENCE_OBSERVABILITY/wp_101_service_slo_alerting.md), [WP-111 — Reliability, Event ve FinOps Kabul Paketi](../10_INTEGRATION_CUTOVER/wp_111_reliability_finops_acceptance.md), [WP-114 — Operations, DR ve Restore Kabul Paketi](../10_INTEGRATION_CUTOVER/wp_114_operations_dr_acceptance.md), [WP-115 — Tam Sistem Regression ve Commissioning Dossier](../10_INTEGRATION_CUTOVER/wp_115_full_system_regression.md)
