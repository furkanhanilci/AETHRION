...
- Bağımlılıklar kabul edilmiştir: [WP-021 — Development, Staging ve Production Ortam Baseline'ı](../03_FOUNDATION/WP-021_ortam_hesap_ag_baseline.md), [WP-022 — Repository Topolojisi ve Kod Sahipliği](../03_FOUNDATION/WP-022_repository_topolojisi.md), [WP-024 — CI Temeli ve Deterministik Kalite Kapıları](../03_FOUNDATION/WP-024_ci_kalite_kapilari.md), [WP-026 — Content-Addressed Object Store ve WORM](../03_FOUNDATION/WP-026_object_store_worm.md)
