> [!info] Generated view
> This note is generated from `docs/architecture/AIRL_OS_ROLES.md` in the repository. Edit the
> canonical file and regenerate; edits made here are overwritten.

# AIRL-OS — Role Definitions and Authority Flows
...
| Sibling documents | `AIRL_OS_ARCHITECTURE.md` §6 · `AIRL_OS_ROLE_MODEL_ASSIGNMENT.md` (which model executes what) · `AIRL_OS_IDEAL_STRUCTURE.md` A1–A8 (why each role was added) |
