> [!info] Generated view
> This note is generated from `docs/architecture/AIRL_OS_SKILL_LAYER.md` in the repository. Edit the
> canonical file and regenerate; edits made here are overwritten.

# AIRL-OS Skill Layer — Full `obra/superpowers` Integration Report
...
> **AIRL-OS uses `RoleContract` to define *who* an agent is.
...
**Why this is critical for AIRL-OS:**
...
### 2.2 A rationalisation table adapted to AIRL-OS
...
**Applying this directly to AIRL-OS:** your `RoleContract.purpose` field currently
...
## 3. Skill anatomy — the AIRL-OS adaptation

To Superpowers' `SKILL.md` schema, I add the fields AIRL-OS needs (**bold** items
are added):
...
|---|---|---|
| `using-airl-os` | `using-superpowers` | Entry point; which skill applies in which situation |
...
The one-to-one translation of `verification-before-completion` into AIRL-OS:
...
| Skill | Superpowers counterpart | What it does in AIRL-OS |
|---|---|---|
...
| Skill | Job (see `AIRL_OS_IDEAL_STRUCTURE.md` Section C) |
|---|---|
...
**multi-analyst** proposal in `AIRL_OS_IDEAL_STRUCTURE.md` Section B3:

| Superpowers rule | AIRL-OS application |
|---|---|
...
2. **Full-word confirmation:**
   ...
   The AIRL-OS counterpart — **full-word confirmation is mandatory for
...
The AIRL-OS counterpart: **AN ANOMALY MAY NOT BE "FIXED" OR EXCLUDED BEFORE ITS
...
| Phase | Superpowers (code) | AIRL-OS (research) |
|---|---|---|
...
Superpowers' hardest skill is TDD. Its AIRL-OS counterpart is this one, and it
...
Combined with **in-principle acceptance** (`AIRL_OS_IDEAL_STRUCTURE.md`
