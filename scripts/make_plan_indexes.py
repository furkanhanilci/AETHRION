...
def build(directory: Path) -> str:
    ...
    out = [f"# {name} — {title}", "",
           ...
           "| Live state | This index shows the status frozen at the baseline. What is true "
           "**now** is in [`docs/READY.md`](../../../docs/READY.md), generated from "
           "`delivery/progress.json`, which is not sealed |", "",
