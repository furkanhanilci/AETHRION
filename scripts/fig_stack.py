...
LAYERS = [
    ...
    ("Collaboration", [("CollaborationBackend contract", OWNED, False),
                       ("Buzz backend", DEP, False),
                       ("cohort · topology · embargo", OWNED, False)]),
    ("Agent runtime", [("AgentRuntime contract", OWNED, False),
                       ("buzz-acp", DEP, False), ("Hermes", DEP, False),
                       ("Codex · Claude Code · Buzz Agent", DEP, False)]),
