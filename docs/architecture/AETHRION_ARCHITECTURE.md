...
flowchart LR
    subgraph WORKING["RUNNING — verified locally"]
        W["Zotero read-only client<br/>SQLite source registry<br/>Obsidian projection<br/>Hermes MCP · 5 tools<br/>systemd units · 173 tests<br/>plan seal · 22 status checks<br/>signed evidence manifest<br/>21 generated figures"]
    end
