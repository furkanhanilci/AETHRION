...
flowchart LR
    subgraph WORKING["RUNNING — verified locally"]
        W["Zotero read-only client<br/>SQLite source registry<br/>Obsidian projection<br/>Hermes MCP · 5 tools<br/>systemd units · 140 tests<br/>plan seal · 20 status checks<br/>signed evidence manifest<br/>14 generated figures"]
    end
