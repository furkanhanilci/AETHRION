---
title: "Bibliographic corroboration and retraction monitoring of the AIRL-OS source registry"
...
abstract: |
  ...
  AIRL-OS literature bridge: bibliographic corroboration against three public
...
![The target stack, with adoption type and build status marked](../../docs/figures/airl_os_stack.svg){#fig-stack fig-alt="Layered diagram of the AIRL-OS target stack, showing which layers are adopted components and which three cells are implemented."}
